...
import { createOpencodeClient } from "@rimurucode-ai/sdk"
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.rimuru-ai.dev/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.rimuru-ai.dev/exchange_github_app_token", {
      method: "POST",
      headers: {

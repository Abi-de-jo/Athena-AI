...
# ตัวจัดการแพ็กเกจ
npm i -g rimuru-ai@latest        # หรือ bun/pnpm/yarn
scoop install rimuru-ai             # Windows
choco install rimuru-ai             # Windows
brew install gowdaman/tap/rimuru-ai # macOS และ Linux (แนะนำ อัปเดตเสมอ)
brew install rimuru-ai              # macOS และ Linux (brew formula อย่างเป็นทางการ อัปเดตน้อยกว่า)
sudo pacman -S rimuru-ai            # Arch Linux (Stable)
paru -S rimuru-ai-bin               # Arch Linux (Latest from AUR)
mise use -g rimuru-ai               # ระบบปฏิบัติการใดก็ได้
nix run nixpkgs#rimuru-ai           # หรือ github:gowdaman/rimuru-ai สำหรับสาขาพัฒนาล่าสุด
```
...
4. `$HOME/.rimuru-ai/bin` - ค่าสำรองเริ่มต้น
...
Rimuru AI รวมเอเจนต์ในตัวสองตัวที่คุณสามารถสลับได้ด้วยปุ่ม `Tab`
...
เรียนรู้เพิ่มเติมเกี่ยวกับ [เอเจนต์](https://rimurucode.vercel.app/docs/agents)

### เอกสารประกอบ

สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีกำหนดค่า Rimuru AI [**ไปที่เอกสารของเรา**](https://rimurucode.vercel.app/docs)

### การมีส่วนร่วม

หากคุณสนใจที่จะมีส่วนร่วมใน Rimuru AI โปรดอ่าน [เอกสารการมีส่วนร่วม](./CONTRIBUTING.md) ก่อนส่ง Pull Request

### การสร้างบน Rimuru AI

หากคุณทำงานในโปรเจกต์ที่เกี่ยวข้องกับ Rimuru AI และใช้ "rimuru-ai" เป็นส่วนหนึ่งของชื่อ เช่น "rimuru-ai-dashboard" หรือ "rimuru-ai-mobile" โปรดเพิ่มหมายเหตุใน README ของคุณเพื่อชี้แจงว่าไม่ได้สร้างโดยทีม Rimuru AI และไม่ได้เกี่ยวข้องกับเราในทางใด

---

**ร่วมชุมชนของเรา** [Discord](https://discord.gg/rimuru-ai) | [X.com](https://x.com/rimuru-ai)

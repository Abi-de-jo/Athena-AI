...
export type Config = {
  ...
  /**
   * Command configuration, see https://github.com/gowdaman-dev/rimuru-ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/gowdaman-dev/rimuru-ai/docs/agent
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig

...
class Database extends Context.Service<Database, DatabaseShape>()("@rimuru/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@rimuru/example/UserStore") {

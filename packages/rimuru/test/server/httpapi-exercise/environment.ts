...
process.env.RIMURU_DISABLE_SHARE = "true"
export const exerciseConfigDirectory = path.join(exerciseGlobalRoot, "config", "rimuru-ai")
export const exerciseDataDirectory = path.join(exerciseGlobalRoot, "data", "rimuru-ai")

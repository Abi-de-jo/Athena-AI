  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("RIMURU_SERVER_PASSWORD", original.envPassword)
        restoreEnv("RIMURU_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            RIMURU_SERVER_PASSWORD: input?.password,
            RIMURU_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),

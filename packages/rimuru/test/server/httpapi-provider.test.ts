...
function writeProviderAuthPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* Effect.promise(() => markPluginDependenciesReady(path.join(dir, ".rimuru")))

    yield* fs.writeWithDirs(
      path.join(dir, ".rimuru", "plugin", "provider-oauth-parity.ts"),
      [
        "export default {",
...
function writeProviderAuthValidationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".rimuru", "plugin", "provider-oauth-validation.ts"),
      [
        "export default {",
...
function writeFunctionOptionsPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".rimuru", "plugin", "provider-function-options.ts"),
      [
        "export default {",
...
function writeProviderModelsMutationPlugin(dir: string) {
  return Effect.gen(function* () {
    ...
    yield* fs.writeWithDirs(
      path.join(dir, ".rimuru", "plugin", "provider-models-mutation.ts"),
      [
        "export default {",
...
describe("provider HttpApi", () => {
  it.instance.skip(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* request("/api/provider/missing", {
        headers: { "x-rimuru-directory": directory },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      const directory = (yield* TestInstance).directory
      const headers = { "x-rimuru-directory": directory, "content-type": "application/json" }
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const response = yield* requestAuthorize({
        ...
        method: 0,
        inputs: { token: "nope" },
        headers: { "x-rimuru-directory": directory, "content-type": "application/json" },
      })
  ...
  it.instance(
    ...
    Effect.gen(function* () {
      ...
      const headers = { "x-rimuru-directory": directory }

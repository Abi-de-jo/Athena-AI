...
//
// The saved variant persists across sessions in ~/.local/state/rimuru/model.json
...
class Service extends Context.Service<Service, VariantService>()("@rimuru/RunVariant") {}

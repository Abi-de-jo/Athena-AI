...
import type { Event, GlobalEvent, RimuruClient } from "@rimurucode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@rimuru/RunStreamTransport") {}

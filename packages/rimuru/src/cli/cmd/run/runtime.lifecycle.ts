...
import { openEditor } from "@rimuru-ai/tui/editor"
import { registerRimuruKeymap } from "@rimuru-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerRimuruKeymap(keymap, renderer, input.tuiConfig)

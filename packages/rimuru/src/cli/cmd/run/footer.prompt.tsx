...
import { normalizePromptContent } from "@rimurucode-ai/tui/editor"
...
import { RIMURU_BASE_MODE, useBindings } from "@rimurucode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Rimuru" } satisfies SlashOption,
    ]

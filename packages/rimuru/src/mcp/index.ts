...
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/gowdaman-dev/rimuru-ai/issues/11948
    // sampling: {},
    // https://github.com/gowdaman-dev/rimuru-ai/issues/23066
    // elicitation: {},
    // https://github.com/gowdaman-dev/rimuru-ai/issues/2308
    roots: {},
    // https://github.com/gowdaman-dev/rimuru-ai/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "rimuru-ai", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: rimuru-ai mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))

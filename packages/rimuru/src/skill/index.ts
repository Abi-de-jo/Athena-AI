...
import { FrontmatterError } from "@rimurucode-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@rimurucode-ai/core/util/glob"
...
// Built-in skill that ships with rimuru-ai. The model's intuition for what an
// rimuru.json should look like is often wrong, and rimuru-ai hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch rimuru-ai's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_RIMURU_SKILL_NAME = "customize-rimuru"
const CUSTOMIZE_RIMURU_SKILL_DESCRIPTION =
...
const CUSTOMIZE_RIMURU_SKILL_BODY = SkillPlugin.CustomizeRimuruContent
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_RIMURU_SKILL_NAME] = {
          name: CUSTOMIZE_RIMURU_SKILL_NAME,
          description: CUSTOMIZE_RIMURU_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_RIMURU_SKILL_BODY,
        }

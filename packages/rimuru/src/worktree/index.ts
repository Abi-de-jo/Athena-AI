...
import { path } from "@rimuru-ai/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@rimuru-ai/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `rimuru-ai/${name}`

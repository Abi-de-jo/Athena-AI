...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@rimuru/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@rimuru/ACPDirectory") {}

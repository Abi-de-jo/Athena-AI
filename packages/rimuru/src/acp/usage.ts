...
export type AssistantTokenCost = Pick<RimuruAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<RimuruAssistantMessage, "role"> &
  Partial<Pick<RimuruAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@rimuru/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@rimuru/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@rimuru/ACPUsage") {}

...
<html>
  <head>
    <meta charset="utf-8" />
    <title>Rimuru - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to Rimuru."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Rimuru will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",

...
export const RootHttpApi = HttpApi.make("rimuru-root")
...
export const InstanceHttpApi = HttpApi.make("rimuru-instance")
...
export const RimuruHttpApi = HttpApi.make("rimuru-ai")

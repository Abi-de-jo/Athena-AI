...
export const InstanceApi = HttpApi.make("instance")
      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current Rimuru instance, releasing all resources.",
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the Rimuru instance.",
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the Rimuru system.",
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the Rimuru system.",
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the Rimuru system.",
          }),
        ),
  ...
  .annotateMerge(
    OpenApi.annotations({
      title: "rimuru-ai experimental HttpApi",
      version: "0.0.1",

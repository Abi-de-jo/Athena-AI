      ...
      .add(
        ...
        HttpApiEndpoint.post("consoleSwitch", ExperimentalPaths.consoleSwitch, {
          ...
          OpenApi.annotations({
            ...
            description: "Persist a new active Console account/org selection for the current local Rimuru state.",
          }),
        ),
        ...
        HttpApiEndpoint.get("session", ExperimentalPaths.session, {
          ...
          OpenApi.annotations({
            ...
            description:
              "Get a list of all Rimuru sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
          }),
        ),

    ...
    .add(
      HttpApiEndpoint.get("health", GlobalPaths.health, {
        ...
        OpenApi.annotations({
          ...
          summary: "Get health",
          description: "Get health information about the Rimuru server.",
        }),
      ),
      HttpApiEndpoint.get("event", GlobalPaths.event, {
        ...
        OpenApi.annotations({
          ...
          description: "Subscribe to global events from the Rimuru system using server-sent events.",
        }),
      ),
      HttpApiEndpoint.get("configGet", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Retrieve the current global Rimuru configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.patch("configUpdate", GlobalPaths.config, {
        ...
        OpenApi.annotations({
          ...
          description: "Update global Rimuru configuration settings and preferences.",
        }),
      ),
      HttpApiEndpoint.post("dispose", GlobalPaths.dispose, {
        ...
        OpenApi.annotations({
          ...
          description: "Clean up and dispose all Rimuru instances, releasing all resources.",
        }),
      ),
      HttpApiEndpoint.post("upgrade", GlobalPaths.upgrade, {
        ...
        OpenApi.annotations({
          ...
          summary: "Upgrade rimuru-ai",
          description: "Upgrade rimuru-ai to the specified version or latest if not specified.",
        }),
      ),
    )

...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for rimuru-ai serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(RimuruHttpApi)
...
export const PublicApi = RimuruHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "rimuru-ai",
    version: "1.0.0",
    description: "rimuru-ai api",

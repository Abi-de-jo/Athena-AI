...
>()("@rimuru/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@rimuru/ExperimentalHttpApiWorkspaceRouting") {}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-rimuru-directory"] || process.cwd()
}

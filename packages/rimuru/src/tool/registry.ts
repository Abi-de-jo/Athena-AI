...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@rimurucode-ai/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/ToolRegistry") {}

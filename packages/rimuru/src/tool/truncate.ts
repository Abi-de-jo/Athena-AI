...
export interface Interface {
  ...
  /**
   * Resolved truncation limits: values from `tool_output` in rimuru config, or MAX_LINES / MAX_BYTES if unset.
   */
  readonly limits: () => Effect.Effect<{ maxLines: number; maxBytes: number }>
}

export class Service extends Context.Service<Service, Interface>()("@rimuru/Truncate") {}

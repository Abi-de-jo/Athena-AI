 ...
 *   "@rimuru/ServerAuthConfig",
 *   {
 *     password: Config.string("RIMURU_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("RIMURU_SERVER_USERNAME").pipe(Config.withDefault("rimuru-ai")),
 *   },
 * ) {}
 *

...
import { AbsolutePath, type DeepMutable } from "@rimurucode-ai/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".rimuru", "plans", "*.md")]: "allow",

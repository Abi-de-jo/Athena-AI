...
import { Slug } from "@rimuru-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@rimuru-ai/llm"
...
import { PartTable, SessionTable } from "@rimuru-ai/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@rimuru-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".rimuru", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/Session") {}

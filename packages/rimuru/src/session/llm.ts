...
import { llmClient } from "@rimuru-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@rimuru-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@rimuru-ai/llm/route"
import type { LLMClientService } from "@rimuru-ai/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @rimuru-ai/llm. It

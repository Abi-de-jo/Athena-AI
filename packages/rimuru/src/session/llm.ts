...
import { llmClient } from "@rimurucode-ai/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@rimurucode-ai/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@rimurucode-ai/llm/route"
import type { LLMClientService } from "@rimurucode-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via rimuru's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @rimurucode-ai/llm. It

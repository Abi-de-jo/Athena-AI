...
import type * as SDK from "@rimurucode-ai/sdk/v2"
...
import { SessionShareTable } from "@rimurucode-ai/core/share/sql"
...
const disabled = process.env["RIMURU_DISABLE_SHARE"] === "true" || process.env["RIMURU_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/ShareNext") {}

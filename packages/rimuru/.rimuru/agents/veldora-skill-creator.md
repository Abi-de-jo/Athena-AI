---
description: Veldora SkillForge - Skill Creator subagent. Design and generate reusable skill definitions loadable into agents, tools, and AI systems
mode: subagent
steps: 10
permission:
  read: allow

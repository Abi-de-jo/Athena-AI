...
```
REGISTRY=ghcr.io/gowdaman TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/gowdaman TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/gowdaman/build/bun-node:24.04
```

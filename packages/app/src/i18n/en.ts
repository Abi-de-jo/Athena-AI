export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Rimuru",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Rimuru.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Rimuru Cloud gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "rimuru.app/cloud",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Rimuru.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Rimuru.",
  ...
  "dialog.server.description": "Switch which Rimuru server this app connects to.",
  ...
  "wsl.onboarding.step.rimuru": "Rimuru",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Rimuru...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Rimuru in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Rimuru...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Rimuru in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Rimuru in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Rimuru",
  "wsl.onboarding.opencodeReadyIn": "Rimuru is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Rimuru is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Rimuru in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Rimuru",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Rimuru.",
  ...
  "toast.update.description": "A new version of Rimuru ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Rimuru team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Rimuru does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Rimuru includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Rimuru server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Rimuru",
  ...
  "settings.general.row.appearance.description": "Customise how Rimuru looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Rimuru follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Rimuru is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Rimuru launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Rimuru.",

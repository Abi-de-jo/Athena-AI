...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Rimuru AI tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.opencodeZen.line1":
    "Rimuru Cloud, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "dialog.plugins.empty": "Eklentiler rimuru.json içinde yapılandırılır",
  ...
  "toast.update.description": "Rimuru AI'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (rimuru.json) sağlayıcı/model adlarını kontrol edin",
  ...
  "sidebar.gettingStarted.line1": "Rimuru AI ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Rimuru AI Masaüstü",
  ...
  "settings.desktop.wsl.description": "Rimuru AI sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Rimuru AI'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Rimuru AI'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Rimuru AI'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Rimuru AI'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Rimuru AI başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Rimuru AI'un en son sürümünü kullanıyorsunuz.",

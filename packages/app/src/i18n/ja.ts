export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Rimuru AIが提供する無料モデル",
  ...
  "provider.connect.opencodeZen.line1":
    "Rimuru Cloudは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "dialog.plugins.empty": "rimuru.jsonで設定されたプラグイン",
  ...
  "toast.update.description": "Rimuru AIの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.chain.checkConfig": "config (rimuru.json) のプロバイダー/モデル名を確認してください",
  ...
  "sidebar.gettingStarted.line1": "Rimuru AIには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Rimuru AIの表示言語を変更します",
  ...
  "settings.general.row.colorScheme.description": "Rimuru AIがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Rimuru AIのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Rimuru AI の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Rimuru AI は最新バージョンです。",

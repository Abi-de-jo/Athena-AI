...
export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Rimuru Cloud bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "dialog.plugins.empty": "In rimuru.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (rimuru.json) auf Anbieter-/Modellnamen",
  ...
  "sidebar.gettingStarted.line1": "Rimuru AI enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Rimuru AI-Server innerhalb von WSL unter Windows ausführen.",

export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Rimuru AI에서 제공하는 무료 모델",
  ...
  "provider.connect.opencodeZen.line1":
    "Rimuru Cloud은 코딩 에이전트를 위해 최적화된 신뢰할 수 있는 엄선된 모델에 대한 액세스를 제공합니다.",
  ...
  "dialog.plugins.empty": "rimuru.json에 구성된 플러그인",
  ...
  "toast.update.description": "Rimuru AI의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.chain.checkConfig": "구성(rimuru.json)의 공급자/모델 이름을 확인하세요",
  ...
  "sidebar.gettingStarted.line1": "Rimuru AI에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.row.language.description": "Rimuru AI 표시 언어 변경",
  ...
  "settings.general.row.colorScheme.description": "Rimuru AI가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Rimuru AI 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Rimuru AI를 실행할 때 업데이트를 자동으로 확인합니다",

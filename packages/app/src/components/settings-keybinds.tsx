...
const ButtonV2 = lazy(() => import("@rimurucode-ai/ui/v2/button-v2").then((module) => ({ default: module.ButtonV2 })))
const IconV2 = lazy(() => import("@rimurucode-ai/ui/v2/icon").then((module) => ({ default: module.Icon })))
const IconButtonV2 = lazy(() =>
  import("@rimurucode-ai/ui/v2/icon-button-v2").then((module) => ({ default: module.IconButtonV2 })),
)
const TextInputV2 = lazy(() =>
  import("@rimurucode-ai/ui/v2/text-input-v2").then((module) => ({ default: module.TextInputV2 })),
)

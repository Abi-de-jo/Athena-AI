...
beforeAll(async () => {
  ...
  mock.module("@rimuru-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@rimuru-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@rimuru-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@rimuru-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

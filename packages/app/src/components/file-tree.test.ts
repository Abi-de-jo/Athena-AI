...
beforeAll(async () => {
  ...
  mock.module("@rimurucode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@rimurucode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@rimurucode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@rimurucode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))

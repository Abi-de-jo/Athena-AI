import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@rimurucode-ai/sdk/v2/client"
...
import { List, type ListRef } from "@rimurucode-ai/ui/list"
          ...
          <Match when={provider().id === "rimuru-ai"}>
            <div class="flex flex-col gap-4">
              ...
              <div class="text-14-regular text-text-base">
                ...
                <Link href="https://github.com/gowdaman-dev/rimuru-ai/zen" tabIndex={-1}>

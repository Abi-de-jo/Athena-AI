...
import { ResizeHandle } from "@rimurucode-ai/ui/resize-handle"
...
import { Session, type Message } from "@rimurucode-ai/sdk/v2/client"
...
import { toaster } from "@rimurucode-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@rimurucode-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/gowdaman-dev/rimuru-ai/desktop-feedback")}
      renderPanel={() =>

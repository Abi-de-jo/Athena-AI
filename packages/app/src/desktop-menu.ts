...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenCode Documentation", href: "https://github.com/gowdaman-dev/rimuru-ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/gowdaman-dev/rimuru-ai/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/gowdaman-dev/rimuru-ai/issues/new?template=bug_report.yml",
      },
    ],
  },
]

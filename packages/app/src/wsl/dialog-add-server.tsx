...
import { showToast } from "@rimurucode-ai/ui/toast"
        ...
        title:
          step === "wsl"
            ...
            : step === "distro"
              ...
              : language.t("wsl.onboarding.step.rimuru"),
        state:
          active === step
            ? "current"
            : step === "wsl"
        ...
        >
          ...
          <Switch>
            ...
            <Match when={activeStep() === "rimuru-ai"}>
              <div class="rounded-md bg-surface-base p-4 flex flex-col gap-3">
                <div class="flex items-center justify-between gap-3">
                  <div class="text-14-medium text-text-strong">{language.t("wsl.onboarding.step.rimuru")}</div>
                  <div class="flex items-center gap-2">
                    <Show when={selectedDistro()}>
                      <Button
                        variant="ghost"

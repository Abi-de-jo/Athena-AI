...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | Rimuru",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "Rimuru AI Logo hell",
  "notFound.logoDarkAlt": "Rimuru AI Logo dunkel",
  ...
  "app.meta.description": "Rimuru AI - Der Open-Source Coding-Agent.",

  "home.title": "Rimuru AI | Der Open-Source AI-Coding-Agent",

  "temp.title": "Rimuru AI | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von Rimuru",
  ...
  "temp.screenshot.caption": "Rimuru AI TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "Rimuru AI TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "Rimuru AI Logo hell",
  "temp.logoDarkAlt": "Rimuru AI Logo dunkel",
  ...
  "home.what.title": "Was ist Rimuru?",
  "home.what.body":
    "Rimuru AI ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird Rimuru von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "Rimuru AI speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist Rimuru?",
  "home.faq.a1":
    "Rimuru AI ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich Rimuru?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um Rimuru zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, Rimuru kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert Rimuru auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit Rimuru nutzen?",
  "home.faq.a4.p1":
    "Ja, Rimuru unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich Rimuru nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! Rimuru ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet Rimuru?",
  "home.faq.a6":
    "Rimuru AI ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist Rimuru Open Source?",
  "home.faq.a8.p1": "Ja, Rimuru ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die Rimuru speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "Rimuru AI Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die Rimuru speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist Rimuru Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter Rimuru.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann Rimuru Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt Rimuru nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit Rimuru funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für Rimuru-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit Rimuru zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "Rimuru Go | Kostengünstige Coding-Modelle für alle",
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die Rimuru-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. Rimuru Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit Rimuru oder jedem Agenten nutzen.",
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du Rimuru Go abonnierst - {{link}}",

  "black.meta.title": "Rimuru Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit Rimuru Black Abos.",
  ...
  "black.title": "Rimuru Black | Preise",
  ...
  "black.workspace.title": "Rimuru Black | Workspace wählen",
  "black.workspace.selectPlan": "Wähle einen Workspace für diesen Plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Rimuru Black abonnieren",
  ...
  "black.subscribe.success.title": "Du bist auf der Rimuru Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit Rimuru, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle Rimuru",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte Rimuru und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf Rimuru-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen Rimuru Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast Rimuru Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.black.waitlist.joined": "Du bist auf der Warteliste für den ${{plan}} pro Monat Rimuru Black Plan.",
  "workspace.black.waitlist.ready": "Wir sind bereit, dich in den ${{plan}} pro Monat Rimuru Black Plan aufzunehmen.",
  ...
  "workspace.lite.subscription.message": "Du hast Rimuru Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "Rimuru Go" als Anbieter in deiner rimuru-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.black.message":
    "Du hast derzeit Rimuru Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat Rimuru Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "Rimuru Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.title": "Rimuru AI | Download",
  "download.meta.description": "Lade Rimuru für macOS, Windows und Linux herunter",
  "download.hero.title": "Rimuru AI herunterladen",
  ...
  "download.section.integrations": "Rimuru AI Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du Rimuru mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert Rimuru mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Rimuru AI ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während Rimuru mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in Rimuru erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "Rimuru AI | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie Rimuru für Enterprise-Lösungen",
  ...
  "enterprise.faq.q1": "Was ist Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. Rimuru speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit Rimuru Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. Rimuru speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "Rimuru AI | Marke",
  "brand.meta.description": "Rimuru AI Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der Rimuru-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Rimuru AI Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für Rimuru",

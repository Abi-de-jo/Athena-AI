...
export const dict = {
  ...
  "notFound.title": "Non trovato | rimuru",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di rimuru",
  "notFound.logoDarkAlt": "logo scuro di rimuru",
  ...
  "app.meta.description": "Rimuru AI - L'agente di programmazione open source.",

  "home.title": "Rimuru AI | L'agente di coding IA open source",

  "temp.title": "rimuru | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da rimuru",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "Rimuru AI TUI con il tema tokyonight",
  "temp.screenshot.alt": "Rimuru AI TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di rimuru",
  "temp.logoDarkAlt": "logo scuro di rimuru",
  ...
  "home.what.title": "Che cos'è Rimuru?",
  "home.what.body": "Rimuru AI è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Rimuru è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Rimuru AI non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è Rimuru?",
  "home.faq.a1":
    "Rimuru AI è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Rimuru?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Rimuru?",
  "home.faq.a3.p1":
    "Non necessariamente: Rimuru include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Rimuru funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Rimuru?",
  "home.faq.a4.p1":
    "Sì, Rimuru supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Rimuru solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! Rimuru ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Rimuru?",
  "home.faq.a6":
    "Rimuru AI è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Rimuru AI è open source?",
  "home.faq.a8.p1": "Sì, Rimuru è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Rimuru ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "Rimuru AI Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Rimuru ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è Rimuru Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Rimuru.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più Rimuru può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Rimuru aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Rimuru, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Rimuru.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con Rimuru, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "Rimuru Go | Modelli di coding a basso costo per tutti",
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza Rimuru a quante più persone possibile. Rimuru Go è un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con Rimuru o qualsiasi agente.",
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} è terminata. Puoi continuare a usare il modello abbonandoti a Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento Rimuru Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "Rimuru Black | Prezzi",
  ...
  "black.workspace.title": "Rimuru Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a Rimuru Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con rimuru quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona rimuru",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia rimuru ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi rimuru.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API rimuru Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a Rimuru Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano Rimuru Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano Rimuru Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "Rimuru Go" come provider nella tua configurazione rimuru per utilizzare i modelli Go.',
  "workspace.lite.black.message":
    "Attualmente sei abbonato a Rimuru Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace è già abbonato a Rimuru Go. Solo un membro per workspace può abbonarsi.",
  "workspace.lite.promo.description":
    "Rimuru Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica Rimuru per macOS, Windows e Linux",
  "download.hero.title": "Scarica Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Rimuru a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Rimuru funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Rimuru AI è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Rimuru funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Rimuru.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Rimuru AI | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Rimuru per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "Rimuru AI opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Rimuru per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Sì. Rimuru non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Rimuru AI | Brand",
  "brand.meta.description": "Linee guida del brand Rimuru",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Rimuru.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Rimuru",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Rimuru",

export const dict = {
  ...
  "notFound.title": "Not Found | rimuru",
  ...
  "app.meta.description": "Rimuru AI - The open source coding agent.",

  "home.title": "Rimuru AI | The open source AI coding agent",

  "temp.title": "rimuru | AI coding agent built for the terminal",
  ...
  "temp.feature.zen.afterLink": "provided by rimuru",
  "temp.feature.models.beforeLink": "Supports 75+ LLM providers through",
  "temp.feature.models.afterLink": ", including local models",
  "temp.screenshot.caption": "rimuru TUI with the tokyonight theme",
  "temp.screenshot.alt": "rimuru TUI with tokyonight theme",
  ...
  "home.what.title": "What is Rimuru?",
  "home.what.body": "Rimuru AI is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "home.growth.body":
    "With over <strong>{{stars}}</strong> GitHub stars, <strong>{{contributors}}</strong> contributors, and over <strong>{{commits}}</strong> commits, Rimuru is used and trusted by over <strong>{{monthlyUsers}}</strong> developers every month.",
  ...
  "home.privacy.body":
    "Rimuru AI does not store any of your code or context data, so that it can operate in privacy sensitive environments.",
  "home.privacy.learnMore": "Learn more about",
  "home.privacy.link": "privacy",

  "home.faq.q1": "What is Rimuru?",
  "home.faq.a1":
    "Rimuru AI is an open source agent that helps you write and run code with any AI model. It's available as a terminal-based interface, desktop app, or IDE extension.",
  "home.faq.q2": "How do I use Rimuru?",
  "home.faq.a2.before": "The easiest way to get started is to read the",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Do I need extra AI subscriptions to use Rimuru?",
  "home.faq.a3.p1":
    "Not necessarily, Rimuru comes with a set of free models that you can use without creating an account.",
  ...
  "home.faq.a3.p3":
    "While we encourage users to use Zen, Rimuru also works with all popular providers such as OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "You can even connect your",
  "home.faq.a3.p4.localLink": "local models",
  "home.faq.q4": "Can I use my existing AI subscriptions with Rimuru?",
  "home.faq.a4.p1":
    "Yes, Rimuru supports subscription plans from all major providers. You can use your Claude Pro/Max, ChatGPT Plus/Pro, or GitHub Copilot subscriptions.",
  "home.faq.q5": "Can I only use Rimuru in the terminal?",
  "home.faq.a5.beforeDesktop": "Not anymore! Rimuru is now available as an app for your",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "and",
  "home.faq.a5.web": "web",
  "home.faq.q6": "How much does Rimuru cost?",
  "home.faq.a6":
    "Rimuru AI is 100% free to use. It also comes with a set of free models. There might be additional costs if you connect any other provider.",
  ...
  "home.faq.q8": "Is Rimuru open source?",
  "home.faq.a8.p1": "Yes, Rimuru is fully open source. The source code is public on",
  ...
  "home.zenCta.body":
    "Zen gives you access to a handpicked set of AI models that Rimuru has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality across providers, use validated models that work.",
  "home.zenCta.link": "Learn about Zen",

  "zen.title": "Rimuru AI Zen | A curated set of reliable optimized models for coding agents",
  "zen.hero.title": "Reliable optimized models for coding agents",
  "zen.hero.body":
    "Zen gives you access to a curated set of AI models that Rimuru has tested and benchmarked specifically for coding agents. No need to worry about inconsistent performance and quality, use validated models that work.",

  "zen.faq.q1": "What is Rimuru Zen?",
  "zen.faq.a1":
    "Zen is a curated set of AI models tested and benchmarked for coding agents created by the team behind Rimuru.",
  ...
  "zen.faq.a3":
    "Zen is not for profit. Zen passes through the costs from the model providers to you. The higher Zen's usage the more Rimuru can negotiate better rates and pass those to you.",
  ...
  "zen.faq.a4.p3": "To cover costs, Rimuru adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "zen.faq.a8":
    "While Zen works great with Rimuru, you can use Zen with any agent. Follow the setup instructions in your preferred coding agent.",
  ...
  "zen.problem.subtitle": "We're fixing this for everyone, not just Rimuru users.",
  ...
  "zen.how.body": "While we suggest you use Zen with Rimuru, you can use Zen with any agent.",
  ...
  "go.title": "Rimuru Go | Low cost coding models for everyone",
  ...
  "go.problem.body":
    "We're focused on bringing the Rimuru experience to as many people as possible. Rimuru Go is a low cost subscription: $5 for your first month, then $10/month. It provides generous limits and reliable access to the most capable open source models.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go starts at $5 for your first month, then $10/month. You can use it with Rimuru or any agent.",
  ...
  "zen.api.error.trialEnded":
    "Free promotion has ended for {{model}}. You can continue using the model by subscribing to Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Access all the world's best coding models",
  "black.meta.description": "Get access to Claude, GPT, Gemini and more with Rimuru Black subscription plans.",
  "black.hero.title": "Access all the world's best coding models",
  "black.hero.subtitle": "Including Claude, GPT, Gemini and more",
  "black.title": "Rimuru Black | Pricing",
  ...
  "black.workspace.title": "Rimuru Black | Select Workspace",
  "black.workspace.selectPlan": "Select a workspace for this plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Subscribe to Rimuru Black",
  ...
  "black.subscribe.success.title": "You're on the Rimuru Black waitlist",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen with any coding agent, and continue using other providers with rimuru whenever you want.",
  ...
  "workspace.newUser.step.login.after": "and select rimuru",
  "workspace.newUser.step.pasteKey": "Paste your API key",
  "workspace.newUser.step.models.before": "Start rimuru and run",
  ...
  "workspace.keys.subtitle": "Manage your API keys for accessing rimuru services.",
  "workspace.keys.create": "Create API Key",
  "workspace.keys.placeholder": "Enter key name",
  "workspace.keys.empty": "Create an rimuru Gateway API key",
  ...
  "workspace.black.subscription.message": "You are subscribed to Rimuru Black for ${{plan}} per month.",
  ...
  "workspace.black.waitlist.joined": "You are on the waitlist for the ${{plan}} per month Rimuru Black plan.",
  "workspace.black.waitlist.ready": "We're ready to enroll you into the ${{plan}} per month Rimuru Black plan.",
  ...
  "workspace.lite.subscription.message": "You are subscribed to Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Select "Rimuru Go" as the provider in your rimuru configuration to use Go models.',
  "workspace.lite.black.message":
    "You're currently subscribed to Rimuru Black or on the waitlist. Please unsubscribe first if you'd like to switch to Go.",
  "workspace.lite.other.message":
    "Another member in this workspace is already subscribed to Rimuru Go. Only one member per workspace can subscribe.",
  "workspace.lite.promo.description":
    "Rimuru Go starts at {{price}}, then $10/month, and provides reliable access to popular open coding models with generous usage limits.",
  ...
  "download.meta.description": "Download Rimuru for macOS, Windows, and Linux",
  ...
  "download.faq.a3.beforeLocal":
    "Not necessarily, but probably. You'll need an AI subscription if you want to connect Rimuru to a paid provider, although you can work with",
  "download.faq.a3.localLink": "local models",
  "download.faq.a3.afterLocal.beforeZen": "for free. While we encourage users to use",
  "download.faq.a3.afterZen": ", Rimuru works with all popular providers such as OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "Rimuru AI is 100% free to use.",
  "download.faq.a5.p2.beforeZen":
    "Any additional costs will come from your subscription to a model provider. While Rimuru works with any model provider, we recommend using",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Your data and information is only stored when you create sharable links in Rimuru.",
  "download.faq.a6.p2.beforeShare": "Learn more about",
  "download.faq.a6.shareLink": "share pages",

  "enterprise.title": "Rimuru AI | Enterprise solutions for your organisation",
  "enterprise.meta.description": "Contact Rimuru for enterprise solutions",
  "enterprise.hero.title": "Your code is yours",
  "enterprise.hero.body1":
    "Rimuru AI operates securely inside your organization with no data or context stored and no licensing restrictions or ownership claims. Start a trial with your team, then deploy it across your organization by integrating it with your SSO and internal AI gateway.",
  ...
  "enterprise.faq.q1": "What is Rimuru Enterprise?",
  "enterprise.faq.a1":
  ...
  "enterprise.faq.q2": "How do I get started with Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Simply start with an internal trial with your team. Rimuru by default does not store your code or context data, making it easy to get started. Then contact us to discuss pricing and implementation options.",
  ...
  "enterprise.faq.q4": "Is my data secure with Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Yes. Rimuru does not store your code or context data. All processing happens locally or through direct API calls to your AI provider. With central config and SSO integration, your data remains secure within your organization's infrastructure.",

  "brand.title": "Rimuru AI | Brand",
  "brand.meta.description": "Rimuru AI brand guidelines",
  "brand.heading": "Brand guidelines",
  "brand.subtitle": "Resources and assets to help you work with the Rimuru brand.",
  "brand.downloadAll": "Download all assets",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Rimuru AI release notes and changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "New updates and improvements to Rimuru",

...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | rimuru",
  ...
  "app.meta.description": "Rimuru AI - Den open source kodningsagent.",

  "home.title": "Rimuru AI | Den open source AI-kodningsagent",

  "temp.title": "rimuru | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af rimuru",
  ...
  "temp.screenshot.caption": "rimuru TUI med tokyonight-temaet",
  "temp.screenshot.alt": "rimuru TUI med tokyonight-temaet",
  ...
  "home.what.title": "Hvad er Rimuru?",
  "home.what.body":
    "Rimuru AI er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges Rimuru af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "Rimuru AI gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er Rimuru?",
  "home.faq.a1":
    "Rimuru AI er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg Rimuru?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge Rimuru?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Rimuru kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men Rimuru virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med Rimuru?",
  "home.faq.a4.p1":
    "Ja. Rimuru understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge Rimuru i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! Rimuru er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster Rimuru?",
  "home.faq.a6":
    "Rimuru AI er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er Rimuru open source?",
  "home.faq.a8.p1": "Ja, Rimuru er fuldt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et håndplukket sæt AI-modeller, som Rimuru har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet på tværs af udbydere: brug validerede modeller, der virker.",
  "home.zenCta.link": "Læs om Zen",

  "zen.title": "Rimuru AI Zen | Et kurateret sæt af pålidelige, optimerede modeller til kodningsagenter",
  "zen.hero.title": "Pålidelige optimerede modeller til kodningsagenter",
  "zen.hero.body":
    "Zen giver dig adgang til et kurateret sæt AI-modeller, som Rimuru har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er Rimuru Zen?",
  "zen.faq.a1":
    "Zen er et kurateret sæt AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag Rimuru.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan Rimuru forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer Rimuru kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med Rimuru, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun Rimuru-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med Rimuru, kan du bruge Zen med enhver agent.",
  ...
  "go.title": "Rimuru Go | Kodningsmodeller til lav pris for alle",
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe Rimuru-oplevelsen ud til så mange som muligt. Rimuru Go er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter ved $5 for den første måned, derefter $10/måned. Du kan bruge det med Rimuru eller enhver agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampagne for {{model}} er afsluttet. Du kan fortsætte med at bruge modellen ved at abonnere på Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med Rimuru Black-abonnementer.",
  ...
  "black.workspace.title": "Rimuru Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på Rimuru Black-ventelisten",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med rimuru, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg rimuru",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start rimuru og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til rimuru-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en rimuru Gateway API-nøgle",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Rimuru Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned Rimuru Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned Rimuru Black plan.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "Rimuru Go" som udbyder i din rimuru-konfiguration for at bruge Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på Rimuru Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på Rimuru Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "Rimuru Go starter ved {{price}}, derefter $10/måned, og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.meta.description": "Download Rimuru til macOS, Windows og Linux",
  "download.hero.title": "Download Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde Rimuru til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer Rimuru med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Rimuru AI er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom Rimuru fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i Rimuru.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Rimuru AI | Enterprise-løsninger til din organisation",
  "enterprise.meta.description": "Kontakt Rimuru for enterprise-løsninger",
  "enterprise.hero.title": "Din kode er din egen",
  "enterprise.hero.body1":
    "Rimuru AI fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. Rimuru gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Ja. Rimuru gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "Rimuru AI | Brand",
  "brand.meta.description": "Rimuru AI brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med Rimuru-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Rimuru AI versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til Rimuru",

...
export const dict = {
  ...en,
  "app.meta.description": "Rimuru AI - L'agent de code open source.",
  "nav.github": "GitHub",
  ...
  "notFound.title": "Introuvable | Rimuru",
  "notFound.heading": "404 - Page introuvable",
  "notFound.home": "Accueil",
  "notFound.docs": "Documentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "rimuru logo light",
  "notFound.logoDarkAlt": "rimuru logo dark",
  ...
  "home.title": "Rimuru AI | L'agent de code IA open source",

  "temp.title": "Rimuru AI | Agent de code IA conçu pour le terminal",
  "temp.hero.title": "L'agent de code IA conçu pour le terminal",
  "temp.zen": "Rimuru Cloud",
  ...
  "temp.feature.zen.afterLink": "fournie par Rimuru",
  ...
  "temp.screenshot.caption": "Rimuru AI TUI avec le thème tokyonight",
  "temp.screenshot.alt": "Rimuru AI TUI avec le thème tokyonight",
  "temp.logoLightAlt": "rimuru logo light",
  "temp.logoDarkAlt": "rimuru logo dark",
  ...
  "home.what.title": "Qu'est-ce que Rimuru ?",
  "home.what.body":
    "Rimuru AI est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, Rimuru est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "Rimuru AI ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que Rimuru ?",
  "home.faq.a1":
    "Rimuru AI est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser Rimuru ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser Rimuru ?",
  "home.faq.a3.p1":
    "Pas forcément : Rimuru propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais Rimuru fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec Rimuru ?",
  "home.faq.a4.p1":
    "Oui, Rimuru prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser Rimuru uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! Rimuru est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte Rimuru ?",
  "home.faq.a6":
    "Rimuru AI est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "Rimuru AI est-il open source ?",
  "home.faq.a8.p1": "Oui, Rimuru est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Rimuru a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "Rimuru AI Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que Rimuru a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que Rimuru Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière Rimuru.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus Rimuru peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, Rimuru ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec Rimuru, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de Rimuru.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec Rimuru, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "go.title": "Rimuru Go | Modèles de code à faible coût pour tous",
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience Rimuru au plus grand nombre. Rimuru Go est un abonnement à faible coût : $5 pour le premier mois, puis 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go commence à $5 pour le premier mois, puis 10 $/mois. Vous pouvez l'utiliser avec Rimuru ou n'importe quel agent.",
  ...
  "go.faq.q1": "Qu'est-ce que Rimuru Go ?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promotion gratuite de {{model}} est terminée. Vous pouvez continuer à utiliser le modèle en vous abonnant à Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Accédez aux meilleurs modèles de code au monde",
  "black.meta.description": "Accédez à Claude, GPT, Gemini et plus avec les forfaits d'abonnement Rimuru Black.",
  "black.hero.title": "Accédez aux meilleurs modèles de code au monde",
  "black.hero.subtitle": "Y compris Claude, GPT, Gemini et plus",
  "black.title": "Rimuru Black | Tarification",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec Rimuru quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez Rimuru",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez Rimuru et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services Rimuru.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API Rimuru Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à Rimuru Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait Rimuru Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait Rimuru Black à {{plan}} $ par mois.",
  ...
  "workspace.lite.subscription.message": "Vous êtes abonné à Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Sélectionnez "Rimuru Go" comme fournisseur dans votre configuration rimuru pour utiliser les modèles Go.',
  "workspace.lite.black.message":
    "Vous êtes actuellement abonné à Rimuru Black ou sur liste d'attente. Veuillez d'abord vous désabonner si vous souhaitez passer à Go.",
  "workspace.lite.other.message":
    "Un autre membre de cet espace de travail est déjà abonné à Rimuru Go. Un seul membre par espace de travail peut s'abonner.",
  "workspace.lite.promo.description":
    "Rimuru Go commence à {{price}}, puis 10 $/mois, et offre un accès fiable aux modèles de code ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.title": "Rimuru AI | Téléchargement",
  "download.meta.description": "Téléchargez Rimuru pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger Rimuru",
  ...
  "download.section.desktop": "Rimuru AI Desktop (Bêta)",
  "download.section.extensions": "Extensions Rimuru",
  "download.section.integrations": "Intégrations Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter Rimuru à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", Rimuru fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Rimuru AI est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si Rimuru fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans Rimuru.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "Rimuru AI | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez Rimuru pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "Rimuru AI fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que Rimuru Enterprise ?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec Rimuru Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, Rimuru ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec Rimuru Enterprise ?",
  "enterprise.faq.a4":
    "Oui. Rimuru ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "Rimuru AI | Marque",
  "brand.meta.description": "Guide de marque Rimuru",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque Rimuru.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'Rimuru",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour Rimuru",

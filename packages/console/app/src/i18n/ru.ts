...
export const dict = {
  ...
  "notFound.title": "Не найдено | rimuru",
  "notFound.heading": "404 - Страница не найдена",
  "notFound.home": "Главная",
  "notFound.docs": "Документация",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "светлый логотип rimuru",
  "notFound.logoDarkAlt": "темный логотип rimuru",
  ...
  "app.meta.description": "Rimuru AI - AI-агент с открытым кодом для программирования.",

  "home.title": "Rimuru AI | AI-агент с открытым кодом для программирования",

  "temp.title": "rimuru | AI-агент для программирования в терминале",
  ...
  "temp.feature.zen.afterLink": "от rimuru",
  ...
  "temp.screenshot.caption": "Rimuru AI TUI с темой tokyonight",
  "temp.screenshot.alt": "Rimuru AI TUI с темой tokyonight",
  "temp.logoLightAlt": "светлый логотип rimuru",
  "temp.logoDarkAlt": "темный логотип rimuru",
  ...
  "home.what.title": "Что такое Rimuru?",
  "home.what.body":
    "Rimuru AI — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, Rimuru доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "Rimuru AI не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое Rimuru?",
  "home.faq.a1":
    "Rimuru AI — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать Rimuru?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования Rimuru?",
  "home.faq.a3.p1":
    "Не обязательно, Rimuru поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, Rimuru также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с Rimuru?",
  "home.faq.a4.p1":
    "Да, Rimuru поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать Rimuru только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! Rimuru теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит Rimuru?",
  "home.faq.a6":
    "Rimuru AI на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "Rimuru AI — это open source?",
  "home.faq.a8.p1": "Да, Rimuru полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Rimuru протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.zenCta.link": "Узнать о Zen",

  "zen.title": "Rimuru AI Zen | Набор надежных оптимизированных моделей для кодинг-агентов",
  "zen.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Rimuru протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое Rimuru Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за Rimuru.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы Rimuru может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов Rimuru добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с Rimuru, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей Rimuru.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с Rimuru, вы можете использовать его с любым агентом.",
  ...
  "go.title": "Rimuru Go | Недорогие модели для кодинга для всех",
  ...
  "go.problem.body":
    "Мы стремимся сделать Rimuru доступным для как можно большего числа людей. Rimuru Go - это недорогая подписка: $5 за первый месяц, затем $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go начинается с $5 за первый месяц, затем $10/месяц. Вы можете использовать его с Rimuru или любым агентом.",
  ...
  "zen.api.error.trialEnded":
    "Бесплатная акция для {{model}} завершена. Вы можете продолжить использование модели, подписавшись на Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской Rimuru Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "Rimuru Black | Цены",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Zen с любым кодинг-агентом и продолжайте использовать других провайдеров с rimuru, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите rimuru",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите rimuru и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам rimuru.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза rimuru",
  ...
  "workspace.black.subscription.message": "Вы подписаны на Rimuru Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана Rimuru Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану Rimuru Black за ${{plan}} в месяц.",
  ...
  "workspace.lite.subscription.message": "Вы подписаны на Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Выберите "Rimuru Go" в качестве провайдера в настройках rimuru для использования моделей Go.',
  "workspace.lite.black.message":
    "Вы подписаны на Rimuru Black или находитесь в списке ожидания. Пожалуйста, сначала отмените подписку, если хотите перейти на Go.",
  "workspace.lite.other.message":
    "Другой участник в этом рабочем пространстве уже подписан на Rimuru Go. Только один участник в рабочем пространстве может оформить подписку.",
  "workspace.lite.promo.description":
    "Rimuru Go начинается с {{price}}, затем $10/месяц и предоставляет надежный доступ к популярным открытым моделям кодирования с щедрыми лимитами использования.",
  ...
  "download.title": "Rimuru AI | Скачать",
  "download.meta.description": "Скачать Rimuru для macOS, Windows и Linux",
  "download.hero.title": "Скачать Rimuru",
  ...
  "download.section.extensions": "Расширения Rimuru",
  "download.section.integrations": "Интеграции Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить Rimuru к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", Rimuru работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "Rimuru AI на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя Rimuru работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в Rimuru.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "Rimuru AI | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с Rimuru для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "Rimuru AI безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. Rimuru по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Да. Rimuru не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "Rimuru AI | Бренд",
  "brand.meta.description": "Гайдлайны бренда Rimuru",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом Rimuru.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "Rimuru AI | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений Rimuru",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения Rimuru",

...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | rimuru",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "rimuru logo lys",
  "notFound.logoDarkAlt": "rimuru logo mørk",
  ...
  "app.meta.description": "Rimuru AI - Den åpne kildekode kodingsagenten.",

  "home.title": "Rimuru AI | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "rimuru | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av rimuru",
  ...
  "temp.screenshot.caption": "rimuru TUI med tokyonight-tema",
  "temp.screenshot.alt": "rimuru TUI med tokyonight-tema",
  "temp.logoLightAlt": "rimuru logo lys",
  "temp.logoDarkAlt": "rimuru logo mørk",
  ...
  "home.what.title": "Hva er Rimuru?",
  "home.what.body": "Rimuru AI er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes Rimuru av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "Rimuru AI lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er Rimuru?",
  "home.faq.a1":
    "Rimuru AI er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg Rimuru?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke Rimuru?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. Rimuru kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men Rimuru fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med Rimuru?",
  "home.faq.a4.p1":
    "Ja, Rimuru støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke Rimuru i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! Rimuru er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster Rimuru?",
  "home.faq.a6":
    "Rimuru AI er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er Rimuru åpen kildekode?",
  "home.faq.a8.p1": "Ja, Rimuru er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som Rimuru har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "Rimuru AI Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som Rimuru har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er Rimuru Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak Rimuru.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan Rimuru forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger Rimuru til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med Rimuru, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare Rimuru-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med Rimuru, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.title": "Rimuru Go | Rimelige kodemodeller for alle",
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe Rimuru-opplevelsen til så mange som mulig. Rimuru Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med Rimuru eller hvilken som helst agent.",
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med Rimuru Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "Rimuru Black | Priser",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med rimuru når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg rimuru",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start rimuru og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til rimuru-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en rimuru Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på Rimuru Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for Rimuru Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på Rimuru Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.message": "Du abonnerer på Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "Rimuru Go" som leverandør i rimuru-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på Rimuru Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på Rimuru Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "Rimuru Go starter på {{price}}, deretter $10/måned, og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "Rimuru AI | Last ned",
  "download.meta.description": "Last ned Rimuru for macOS, Windows og Linux",
  "download.hero.title": "Last ned Rimuru",
  ...
  "download.section.extensions": "Rimuru Extensions",
  "download.section.integrations": "Rimuru Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble Rimuru til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer Rimuru med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "Rimuru AI er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om Rimuru fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i Rimuru.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "Rimuru AI | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt Rimuru for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "Rimuru AI opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. Rimuru lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Ja. Rimuru lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "Rimuru AI | Merkevare",
  "brand.meta.description": "Rimuru AI retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med Rimuru-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "Rimuru AI | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for Rimuru",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for Rimuru",

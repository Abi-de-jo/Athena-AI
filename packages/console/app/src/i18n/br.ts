...
export const dict = {
  ...
  "notFound.title": "Não encontrado | rimuru",
  "notFound.heading": "404 - Página não encontrada",
  "notFound.home": "Início",
  "notFound.docs": "Documentação",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo rimuru claro",
  "notFound.logoDarkAlt": "logo rimuru escuro",
  ...
  "app.meta.description": "Rimuru AI - O agente de codificação de código aberto.",

  "home.title": "Rimuru AI | O agente de codificação de código aberto com IA",

  "temp.title": "rimuru | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela rimuru",
  ...
  "temp.screenshot.caption": "Rimuru AI TUI com o tema tokyonight",
  "temp.screenshot.alt": "Rimuru AI TUI com tema tokyonight",
  "temp.logoLightAlt": "logo rimuru claro",
  "temp.logoDarkAlt": "logo rimuru escuro",
  ...
  "home.what.title": "O que é Rimuru?",
  "home.what.body":
    "Rimuru AI é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, Rimuru é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "Rimuru AI não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é Rimuru?",
  "home.faq.a1":
    "Rimuru AI é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o Rimuru?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o Rimuru?",
  "home.faq.a3.p1":
    "Não necessariamente, Rimuru vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, Rimuru também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o Rimuru?",
  "home.faq.a4.p1":
    "Sim, Rimuru suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o Rimuru apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! Rimuru agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o Rimuru?",
  "home.faq.a6":
    "Rimuru AI é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "Rimuru AI é código aberto?",
  "home.faq.a8.p1": "Sim, Rimuru é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Rimuru testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "zen.title": "Rimuru AI Zen | Um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.title": "Modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Rimuru testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é Rimuru Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do Rimuru.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a Rimuru pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a Rimuru adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o Rimuru, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do Rimuru.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o Rimuru, você pode usá-lo com qualquer agente.",
  ...
  "go.title": "Rimuru Go | Modelos de codificação de baixo custo para todos",
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do Rimuru para o maior número de pessoas possível. Rimuru Go é uma assinatura de baixo custo: $5 no primeiro mês, depois $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "O Go começa em $5 no primeiro mês, depois $10/mês. Você pode usá-lo com o Rimuru ou qualquer agente.",
  ...
  "zen.api.error.trialEnded":
    "A promoção gratuita do {{model}} terminou. Você pode continuar usando o modelo assinando o Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura Rimuru Black.",
  ...
  "black.title": "Rimuru Black | Preços",
  ...
  "black.workspace.title": "Rimuru Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar Rimuru Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com rimuru sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione rimuru",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o rimuru e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços rimuru.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do rimuru Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o Rimuru Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano Rimuru Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano Rimuru Black de ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "Rimuru Go" como provedor na sua configuração do rimuru para usar os modelos Go.',
  "workspace.lite.black.message":
    "Você está atualmente inscrito no Rimuru Black ou na lista de espera. Por favor, cancele a assinatura primeiro se desejar mudar para o Go.",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o Rimuru Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.description":
    "O Rimuru Go começa em {{price}}, depois $10/mês, e oferece acesso confiável a modelos de codificação abertos populares com limites de uso generosos.",
  ...
  "download.title": "Rimuru AI | Baixar",
  "download.meta.description": "Baixe o Rimuru para macOS, Windows e Linux",
  "download.hero.title": "Baixar Rimuru",
  ...
  "download.section.extensions": "Extensões Rimuru",
  "download.section.integrations": "Integrações Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o Rimuru a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o Rimuru funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O Rimuru é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o Rimuru funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no Rimuru.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "Rimuru AI | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a Rimuru para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O Rimuru opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O Rimuru por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Sim. O Rimuru não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "Rimuru AI | Marca",
  "brand.meta.description": "Diretrizes da marca Rimuru",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca Rimuru.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "Rimuru AI | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do Rimuru",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no Rimuru",

...
export const dict = {
  ...
  "notFound.title": "見つかりません | Rimuru",
  "notFound.heading": "404 - ページが見つかりません",
  "notFound.home": "ホーム",
  "notFound.docs": "ドキュメント",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "rimuruのロゴ（ライト）",
  "notFound.logoDarkAlt": "rimuruのロゴ（ダーク）",
  ...
  "app.meta.description": "Rimuru AI - オープンソースのコーディングエージェント。",

  "home.title": "Rimuru AI | オープンソースのAIコーディングエージェント",

  "temp.title": "Rimuru AI | ターミナル向けに構築されたAIコーディングエージェント",
  ...
  "temp.feature.zen.beforeLink": "Rimuru AIが提供する",
  ...
  "temp.screenshot.caption": "tokyonight テーマを使用した Rimuru TUI",
  "temp.screenshot.alt": "tokyonight テーマの Rimuru TUI",
  "temp.logoLightAlt": "rimuruのロゴ（ライト）",
  "temp.logoDarkAlt": "rimuruのロゴ（ダーク）",
  ...
  "home.what.title": "Rimuru AIとは？",
  "home.what.body":
    "Rimuru AIは、ターミナル、IDE、またはデスクトップでのコード作成を支援するオープンソースのエージェントです。",
  ...
  "home.privacy.body":
    "Rimuru AIはコードやコンテキストデータを一切保存しないため、プライバシーが重視される環境でも利用できます。",
  "home.privacy.learnMore": "詳しくは",
  "home.privacy.link": "プライバシー",

  "home.faq.q1": "Rimuru AIとは？",
  "home.faq.a1":
    "Rimuru AIは、任意のAIモデルでコードの作成・実行を支援するオープンソースのエージェントです。ターミナルベースのインターフェース、デスクトップアプリ、IDE拡張として利用できます。",
  "home.faq.q2": "Rimuru AIの使い方は？",
  "home.faq.a2.before": "最も簡単な始め方は",
  "home.faq.a2.link": "イントロを読む",
  "home.faq.q3": "Rimuru AIには追加のAIサブスクリプションが必要ですか？",
  "home.faq.a3.p1": "必ずしも必要ではありません。Rimuruには、アカウント不要で使える無料モデルが含まれています。",
  "home.faq.a3.p2.beforeZen": "これらに加えて、",
  "home.faq.a3.p2.afterZen": " アカウントを作成することで、人気のコーディングモデルを利用できます。",
  "home.faq.a3.p3":
    "Zenの利用を推奨していますが、RimuruはOpenAI、Anthropic、xAIなどの主要プロバイダーにも対応しています。",
  "home.faq.a3.p4.beforeLocal": "さらに、",
  "home.faq.a3.p4.localLink": "ローカルモデル",
  "home.faq.q4": "既存のAIサブスクリプションをRimuruで使えますか？",
  "home.faq.a4.p1":
    "はい、Rimuruは主要プロバイダーのサブスクリプションプランに対応しています。Claude Pro/Max、ChatGPT Plus/Pro、GitHub Copilotのサブスクリプションを利用できます。",
  "home.faq.q5": "ターミナルだけで使えますか？",
  "home.faq.a5.beforeDesktop": "もう違います！Rimuruは今は",
  "home.faq.a5.desktop": "デスクトップ",
  "home.faq.a5.and": "と",
  "home.faq.a5.web": "ウェブ",
  "home.faq.q6": "Rimuru AIの価格は？",
  "home.faq.a6":
    "Rimuru AIは100%無料で使えます。無料モデルも含まれています。他のプロバイダーに接続する場合は追加費用が発生することがあります。",
  ...
  "home.faq.q8": "Rimuru AIはオープンソースですか？",
  "home.faq.a8.p1": "はい、Rimuruは完全にオープンソースです。ソースコードは",
  "home.faq.a8.p2": "の",
  ...
  "home.zenCta.body":
    "Zenは、Rimuruがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",
  "home.zenCta.link": "Zenについて知る",

  "zen.title": "Rimuru AI Zen | コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.title": "コーディングエージェント向けの信頼できる最適化モデル",
  "zen.hero.body":
    "Zenは、Rimuruがコーディングエージェント向けにテスト・ベンチマーク済みのAIモデルを厳選して提供します。プロバイダー間の性能・品質のブレを気にせず、検証済みのモデルを利用できます。",

  "zen.faq.q1": "Rimuru AI Zenとは？",
  "zen.faq.a1":
    "Zenは、Rimuruのチームが作成した、コーディングエージェント向けにテスト・ベンチマークされたAIモデルの厳選セットです。",
  ...
  "zen.faq.a3":
    "Zenは営利目的ではありません。Zenはモデル提供元のコストをそのままあなたに渡します。Zenの利用が増えるほど、Rimuruはより良いレートを交渉し、その分をあなたに還元できます。",
  "zen.faq.q4": "Zenの料金は？",
  ...
  "zen.faq.a4.p3": "コストを賄うために、Rimuruは$20の残高チャージあたり$1.23の小さな決済手数料のみを追加します。",
  ...
  "zen.faq.a8":
    "ZenはRimuruとの相性が良いですが、どのエージェントでもZenを利用できます。お使いのコーディングエージェントのセットアップ手順に従ってください。",
  ...
  "zen.problem.subtitle": "Rimuru AIユーザーだけでなく、すべての人を対象にこの問題を修正しています。",
  ...
  "zen.how.body": "ZenをRimuruとともに使用することをお勧めしますが、Zenはどのエージェントでも使用できます。",
  ...
  "go.title": "Rimuru Go | すべての人のための低価格なコーディングモデル",
  ...
  "go.problem.body":
    "私たちはRimuruの体験をできるだけ多くの人に届けることに注力しています。Rimuru Goは低価格のサブスクリプションで、最初の月は$5、その後は$10/月です。ゆとりある上限と、最も高性能なオープンソースモデルへの信頼できるアクセスを提供します。",
  "go.problem.subtitle": " ",
  ...
  "go.how.title": "Goの仕組み",
  "go.how.body": "Goは最初の月$5、その後$10/月で始まります。Rimuruまたは任意のエージェントで使えます。",
  ...
  "zen.api.error.trialEnded":
    "{{model}} の無料プロモーションは終了しました。Rimuru Go を購読するとモデルを引き続き使用できます - {{link}}",

  "black.meta.title": "Rimuru Black | 世界最高峰のコーディングモデルすべてにアクセス",
  "black.meta.description": "Rimuru Black サブスクリプションプランで、Claude、GPT、Gemini などにアクセス。",
  "black.hero.title": "世界最高峰のコーディングモデルすべてにアクセス",
  "black.hero.subtitle": "Claude、GPT、Gemini などを含む",
  "black.title": "Rimuru Black | 料金",
  ...
  "black.workspace.title": "Rimuru Black | ワークスペースの選択",
  "black.workspace.selectPlan": "このプランのワークスペースを選択してください",
  "black.workspace.name": "ワークスペース {{n}}",
  "black.subscribe.title": "Rimuru Black を購読する",
  ...
  "black.subscribe.success.title": "Rimuru Black ウェイトリストに登録されました",
  ...
  "workspace.newUser.feature.lockin.body":
    "任意のコーディングエージェントでZenを使用でき、必要に応じていつでもRimuruを備えた他のプロバイダーを使用し続けることができます。",
  ...
  "workspace.newUser.step.login.after": "してRimuruを選択",
  "workspace.newUser.step.pasteKey": "APIキーを貼り付け",
  "workspace.newUser.step.models.before": "Rimuru AIを起動し実行",
  ...
  "workspace.keys.subtitle": "Rimuru AIサービスにアクセスするためのAPIキーを管理します。",
  "workspace.keys.create": "APIキーの作成",
  "workspace.keys.placeholder": "キー名を入力してください",
  "workspace.keys.empty": "Rimuru AIゲートウェイAPIキーを作成する",
  ...
  "workspace.black.subscription.message": "あなたは Rimuru Black を月額 ${{plan}} で購読しています。",
  ...
  "workspace.black.waitlist.joined":
    "あなたは月額 ${{plan}} の Rimuru Black プランのウェイトリストに登録されています。",
  "workspace.black.waitlist.ready": "月額 ${{plan}} の Rimuru Black プランに登録する準備ができました。",
  ...
  "workspace.lite.subscription.message": "あなたは Rimuru Go を購読しています。",
  ...
  "workspace.lite.subscription.selectProvider":
    "Go モデルを使用するには、rimuru の設定で「Rimuru Go」をプロバイダーとして選択してください。",
  "workspace.lite.black.message":
    "現在 Rimuru Black を購読中、またはウェイティングリストに登録されています。Go に切り替える場合は、先に登録を解除してください。",
  "workspace.lite.other.message":
    "このワークスペースの別のメンバーが既に Rimuru Go を購読しています。ワークスペースにつき1人のメンバーのみが購読できます。",
  "workspace.lite.promo.description":
    "Rimuru Goは{{price}}で始まり、その後は$10/月で、人気の高いオープンコーディングモデルへの安定したアクセスと余裕のある利用枠を提供します。",
  ...
  "download.title": "Rimuru AI | ダウンロード",
  "download.meta.description": "Rimuru AI を macOS、Windows、Linux 向けにダウンロード",
  "download.hero.title": "Rimuru AI をダウンロード",
  ...
  "download.faq.a3.beforeLocal":
    "必ずしもそうではありませんが、おそらく必要です。Rimuruを有料プロバイダーに接続したい場合はAIサブスクリプションが必要ですが、",
  "download.faq.a3.localLink": "ローカルモデル",
  "download.faq.a3.afterLocal.beforeZen": "であれば無料で利用できます。ユーザーには",
  "download.faq.a3.afterZen":
    "の利用をお勧めしていますが、RimuruはOpenAI、Anthropic、xAIなどの主要なプロバイダーに対応しています。",

  "download.faq.a5.p1": "Rimuru AIは100%無料で利用できます。",
  "download.faq.a5.p2.beforeZen":
    "追加コストはモデルプロバイダーのサブスクリプションから発生します。Rimuruはどのモデルプロバイダーでも利用できますが、",
  "download.faq.a5.p2.afterZen": "の利用をおすすめします。",

  "download.faq.a6.p1": "あなたのデータと情報は、Rimuruで共有リンクを作成したときにのみ保存されます。",
  "download.faq.a6.p2.beforeShare": "詳しくは",
  "download.faq.a6.shareLink": "共有ページ",

  "enterprise.title": "Rimuru AI | 組織向けエンタープライズソリューション",
  "enterprise.meta.description": "エンタープライズソリューションについてRimuruに問い合わせる",
  "enterprise.hero.title": "あなたのコードはあなたのもの",
  "enterprise.hero.body1":
    "Rimuru AIは、データやコンテキストを一切保存せず、ライセンス制限や所有権の主張もなく、組織内で安全に動作します。チームでのトライアルから始め、SSOや社内AIゲートウェイと統合して組織全体に展開できます。",
  ...
  "enterprise.faq.q1": "Rimuru AI Enterpriseとは？",
  "enterprise.faq.a1":
    "Rimuru AI Enterpriseは、コードとデータが決してインフラの外に出ないことを保証したい組織向けです。SSOや社内AIゲートウェイと統合する集中設定を使用することでこれを実現します。",
  "enterprise.faq.q2": "Rimuru AI Enterpriseを始めるには？",
  "enterprise.faq.a2":
    "まずはチームでの社内トライアルから始めてください。Rimuruはデフォルトでコードやコンテキストデータを保存しないため、簡単に始められます。その後、価格や導入オプションについてお問い合わせください。",
  ...
  "enterprise.faq.q4": "Rimuru AI Enterpriseでデータは安全ですか？",
  "enterprise.faq.a4":
    "はい。Rimuruはコードやコンテキストデータを保存しません。すべての処理はローカル、またはAIプロバイダーへの直接API呼び出しを通じて行われます。集中設定とSSO統合により、データは組織のインフラ内で安全に保たれます。",

  "brand.title": "Rimuru AI | ブランド",
  "brand.meta.description": "Rimuru AI ブランドガイドライン",
  "brand.heading": "ブランドガイドライン",
  "brand.subtitle": "Rimuru AIブランドを扱うためのリソースと素材です。",
  "brand.downloadAll": "すべての素材をダウンロード",

  "changelog.title": "Rimuru AI | 変更履歴",
  "changelog.meta.description": "Rimuru AI リリースノートと変更履歴",
  "changelog.hero.title": "変更履歴",
  "changelog.hero.subtitle": "Rimuru AIの新しいアップデートと改善",

...
export const dict = {
  ...
  "notFound.title": "No encontrado | rimuru",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "rimuru logo claro",
  "notFound.logoDarkAlt": "rimuru logo oscuro",
  ...
  "app.meta.description": "Rimuru AI - El agente de codificación de código abierto.",

  "home.title": "Rimuru AI | El agente de codificación IA de código abierto",

  "temp.title": "rimuru | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por rimuru",
  ...
  "temp.screenshot.caption": "rimuru TUI con el tema tokyonight",
  "temp.screenshot.alt": "rimuru TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de rimuru claro",
  "temp.logoDarkAlt": "logo de rimuru oscuro",
  ...
  "home.what.title": "¿Qué es Rimuru?",
  "home.what.body":
    "Rimuru AI es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, Rimuru es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "Rimuru AI no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es Rimuru?",
  "home.faq.a1":
    "Rimuru AI es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso Rimuru?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar Rimuru?",
  "home.faq.a3.p1":
    "No necesariamente, Rimuru viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, Rimuru también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con Rimuru?",
  "home.faq.a4.p1":
    "Sí, Rimuru soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar Rimuru en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! Rimuru ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta Rimuru?",
  "home.faq.a6":
    "Rimuru AI es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es Rimuru de código abierto?",
  "home.faq.a8.p1": "Sí, Rimuru es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Rimuru ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "Rimuru AI Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que Rimuru ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es Rimuru Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de Rimuru.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá Rimuru negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, Rimuru añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con Rimuru, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de Rimuru.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con Rimuru, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "Rimuru Go | Modelos de programación de bajo coste para todos",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de Rimuru a tantas personas como sea posible. Rimuru Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go comienza en $5 el primer mes, luego 10 $/mes. Puedes usarlo con Rimuru o cualquier agente.",
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de Rimuru Black.",
  ...
  "black.title": "Rimuru Black | Precios",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de Rimuru Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "Rimuru Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con rimuru cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona rimuru",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia rimuru y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de rimuru.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de rimuru Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a Rimuru Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan Rimuru Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan Rimuru Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "Rimuru Go" como proveedor en tu configuración de rimuru para usar los modelos Go.',
  "workspace.lite.black.message":
    "Actualmente estás suscrito a Rimuru Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a Rimuru Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "Rimuru Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "Rimuru AI | Descargar",
  "download.meta.description": "Descarga Rimuru para macOS, Windows y Linux",
  "download.hero.title": "Descargar Rimuru",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "Rimuru Terminal",
  "download.section.desktop": "Rimuru AI Desktop (Beta)",
  "download.section.extensions": "Extensiones Rimuru",
  "download.section.integrations": "Integraciones Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar Rimuru a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", Rimuru funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "Rimuru AI es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque Rimuru funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en Rimuru.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "Rimuru AI | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a Rimuru para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "Rimuru AI opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. Rimuru por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Sí. Rimuru no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "Rimuru AI | Marca",
  "brand.meta.description": "Guías de marca de Rimuru",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca Rimuru.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "Rimuru AI | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de Rimuru",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para Rimuru",

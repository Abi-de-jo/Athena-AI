...
export const dict = {
  ...
  "notFound.title": "Не знайдено | rimuru",
  "notFound.heading": "404 — Сторінку не знайдено",
  "notFound.home": "Головна",
  "notFound.docs": "Документація",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "світлий логотип rimuru",
  "notFound.logoDarkAlt": "темний логотип rimuru",
  ...
  "app.meta.description": "Rimuru AI — відкритий агент для програмування.",

  "home.title": "Rimuru AI | Відкритий AI-агент для кодування",

  "temp.title": "rimuru | AI-агент для кодування, створений для термінала",
  ...
  "temp.feature.zen.afterLink": "від rimuru",
  "temp.feature.models.beforeLink": "Підтримує 75+ LLM-провайдерів через",
  "temp.feature.models.afterLink": ", включаючи локальні моделі",
  "temp.screenshot.caption": "Rimuru AI TUI з темою tokyonight",
  "temp.screenshot.alt": "Rimuru AI TUI з темою tokyonight",
  "temp.logoLightAlt": "світлий логотип rimuru",
  "temp.logoDarkAlt": "темний логотип rimuru",
  ...
  "home.what.title": "Що таке Rimuru?",
  "home.what.body": "Rimuru AI — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, Rimuru використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "Rimuru AI не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке Rimuru?",
  "home.faq.a1":
    "Rimuru AI — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися Rimuru?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання Rimuru?",
  "home.faq.a3.p1":
    "Не обов'язково, Rimuru має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, Rimuru також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з Rimuru?",
  "home.faq.a4.p1":
    "Так, Rimuru підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати Rimuru лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! Rimuru тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує Rimuru?",
  "home.faq.a6":
    "Rimuru AI є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є Rimuru відкритим?",
  "home.faq.a8.p1": "Так, Rimuru повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які Rimuru протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "Rimuru AI Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які Rimuru протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке Rimuru Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою Rimuru.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни Rimuru може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, Rimuru додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з Rimuru, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів Rimuru.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з Rimuru, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "Rimuru Go | Недорогі моделі кодування для всіх",
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід Rimuru доступним для якомога більшої кількості людей. Rimuru Go — це недорога підписка: $5 за перший місяць, потім $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go починається від $5 за перший місяць, потім $10/місяць. Використовуйте з Rimuru або будь-яким агентом.",
  ...
  "zen.api.error.trialEnded":
    "Безкоштовна акція для {{model}} закінчилася. Ви можете продовжити використання, підписавшись на Rimuru Go — {{link}}",

  "black.meta.title": "Rimuru Black | Доступ до найкращих моделей кодування",
  "black.meta.description": "Отримайте доступ до Claude, GPT, Gemini та інших із планами підписки Rimuru Black.",
  "black.hero.title": "Доступ до найкращих моделей кодування",
  "black.hero.subtitle": "Включаючи Claude, GPT, Gemini та інші",
  "black.title": "Rimuru Black | Ціни",
  ...
  "black.workspace.title": "Rimuru Black | Виберіть робочий простір",
  "black.workspace.selectPlan": "Виберіть робочий простір для цього плану",
  "black.workspace.name": "Робочий простір {{n}}",
  "black.subscribe.title": "Підписатися на Rimuru Black",
  ...
  "black.subscribe.success.title": "Ви в списку очікування Rimuru Black",
  ...
  "workspace.newUser.step.login.after": "і виберіть rimuru",
  "workspace.newUser.step.pasteKey": "Вставте ключ API",
  "workspace.newUser.step.models.before": "Запустіть rimuru і виконайте",
  ...
  "workspace.keys.subtitle": "Керуйте ключами API для доступу до сервісів rimuru.",
  "workspace.keys.create": "Створити ключ API",
  "workspace.keys.placeholder": "Введіть назву ключа",
  "workspace.keys.empty": "Створіть ключ API шлюзу rimuru",
  ...
  "workspace.black.subscription.message": "Ви підписані на Rimuru Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план Rimuru Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план Rimuru Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider": 'Виберіть "Rimuru Go" як провайдера в конфігурації rimuru.',
  "workspace.lite.black.message":
    "Ви вже підписані на Rimuru Black або в списку очікування. Спочатку скасуйте підписку, якщо хочете перейти на Go.",
  "workspace.lite.other.message": "Інший учасник цього робочого простору вже підписаний на Rimuru Go.",
  "workspace.lite.promo.description": "Rimuru Go починається від {{price}}, потім $10/місяць, із щедрими лімітами.",
  ...
  "download.title": "Rimuru AI | Завантажити",
  "download.meta.description": "Завантажте Rimuru для macOS, Windows та Linux",
  "download.hero.title": "Завантажити Rimuru",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал Rimuru",
  "download.section.desktop": "Десктоп Rimuru (Бета)",
  "download.section.extensions": "Розширення Rimuru",
  "download.section.integrations": "Інтеграції Rimuru",
  ...
  "download.faq.a3.afterZen":
    ", Rimuru працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "Rimuru AI є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в Rimuru.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "Rimuru AI | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з Rimuru для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "Rimuru AI працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке Rimuru Enterprise?",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з Rimuru Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. Rimuru за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з Rimuru Enterprise?",
  "enterprise.faq.a4":
    "Так. Rimuru не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "Rimuru AI | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду Rimuru",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом Rimuru.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "Rimuru AI | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін Rimuru",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення Rimuru",

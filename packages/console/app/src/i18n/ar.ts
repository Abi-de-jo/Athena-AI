...
export const dict = {
  ...
  "notFound.title": "غير موجود | rimuru",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار rimuru الفاتح",
  "notFound.logoDarkAlt": "شعار rimuru الداكن",
  ...
  "app.meta.description": "Rimuru AI - وكيل البرمجة مفتوح المصدر.",

  "home.title": "Rimuru AI | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",

  "temp.title": "rimuru | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من rimuru",
  "temp.feature.models.beforeLink": "يدعم أكثر من 75 مزود LLM من خلال",
  "temp.feature.models.afterLink": "، بما في ذلك النماذج المحلية",
  "temp.screenshot.caption": "واجهة Rimuru الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة Rimuru الطرفية بسمة tokyonight",
  "temp.logoLightAlt": "شعار rimuru الفاتح",
  "temp.logoDarkAlt": "شعار rimuru الداكن",
  ...
  "home.what.title": "ما هو Rimuru؟",
  "home.what.body": "Rimuru AI وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم Rimuru ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن Rimuru أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو Rimuru؟",
  "home.faq.a1":
    "Rimuru AI وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم Rimuru؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام Rimuru؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ Rimuru يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن Rimuru يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع Rimuru؟",
  "home.faq.a4.p1":
    "نعم، يدعم Rimuru خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام Rimuru في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! Rimuru متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة Rimuru؟",
  "home.faq.a6":
    "Rimuru AI مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل Rimuru مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، Rimuru مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها Rimuru وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  "home.zenCta.link": "تعرف على Zen",

  "zen.title": "Rimuru AI Zen | مجموعة منسقة من النماذج المحسنة والموثوقة لوكلاء البرمجة",
  "zen.hero.title": "نماذج محسنة وموثوقة لوكلاء البرمجة",
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها Rimuru وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو Rimuru Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ Rimuru.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن Rimuru من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف Rimuru فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع Rimuru، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي Rimuru.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع Rimuru، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "go.title": "Rimuru Go | نماذج برمجة منخفضة التكلفة للجميع",
  ...
  "go.problem.body":
    "نحن نركز على تقديم تجربة Rimuru لأكبر عدد ممكن من الناس. Rimuru Go هو اشتراك منخفض التكلفة: $5 للشهر الأول، ثم $10/شهر. يوفر حدودا سخية ووصولا موثوقا إلى نماذج المصدر المفتوح الأكثر قدرة.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "يبدأ Go من $5 للشهر الأول، ثم $10/شهر. يمكنك استخدامه مع Rimuru أو أي وكيل.",
  ...
  "zen.api.error.trialEnded":
    "انتهى العرض المجاني لـ {{model}}. يمكنك مواصلة استخدام النموذج بالاشتراك في Rimuru Go - {{link}}",

  "black.meta.title": "Rimuru Black | الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.meta.description": "احصل على وصول إلى Claude، GPT، Gemini والمزيد مع خطط اشتراك Rimuru Black.",
  "black.hero.title": "الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.hero.subtitle": "بما في ذلك Claude، GPT، Gemini والمزيد",
  "black.title": "Rimuru Black | الأسعار",
  ...
  "black.workspace.title": "Rimuru Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في Rimuru Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار Rimuru Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع rimuru وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر rimuru",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ rimuru ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات rimuru.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة rimuru",
  ...
  "workspace.black.subscription.message": "أنت مشترك في Rimuru Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة Rimuru Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة Rimuru Black بقيمة ${{plan}} شهريًا.",
  ...
  "workspace.lite.subscription.message": "أنت مشترك في Rimuru Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "Rimuru Go" كمزود في إعدادات rimuru الخاصة بك لاستخدام نماذج Go.',
  "workspace.lite.black.message":
    "أنت مشترك حاليًا في Rimuru Black أو في قائمة الانتظار. يرجى إلغاء الاشتراك أولاً إذا كنت ترغب في التبديل إلى Go.",
  "workspace.lite.other.message":
    "عضو آخر في مساحة العمل هذه مشترك بالفعل في Rimuru Go. يمكن لعضو واحد فقط لكل مساحة عمل الاشتراك.",
  "workspace.lite.promo.description":
    "يبدأ Rimuru Go بسعر {{price}}، ثم $10/شهر، ويوفر وصولا موثوقا لنماذج البرمجة المفتوحة الشهيرة مع حدود استخدام سخية.",
  ...
  "download.title": "Rimuru AI | تنزيل",
  "download.meta.description": "نزّل Rimuru لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل Rimuru",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "Rimuru AI للطرفية",
  "download.section.desktop": "Rimuru AI لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات Rimuru",
  "download.section.integrations": "تكاملات Rimuru",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط Rimuru بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن Rimuru يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "Rimuru AI مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل Rimuru مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في Rimuru.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "Rimuru AI | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع Rimuru لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل Rimuru بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو Rimuru Enterprise؟",
  "enterprise.faq.a1":
    "Rimuru AI Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع Rimuru Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم Rimuru بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع Rimuru Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم Rimuru بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "Rimuru AI | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ Rimuru",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ Rimuru.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "Rimuru AI | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ Rimuru",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ Rimuru",

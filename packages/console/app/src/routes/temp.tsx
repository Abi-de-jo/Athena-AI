    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">rimurucode.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>rimuru-code</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>rimuru-code</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>rimuru</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>rimuru-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/rimurucode">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/gowdaman-dev/rimuru-ai">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/gowdaman-dev/rimuru-ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
      ...
      <div data-component="legal">
        <span>
          ©2025 <a href="https://anoma.ly">Rimuru</a>
        </span>
      </div>
    </main>
  )

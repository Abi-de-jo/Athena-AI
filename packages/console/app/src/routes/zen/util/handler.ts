...
import { and, Database, eq, isNull, lt, or, sql } from "@rimurucode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@rimurucode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@rimurucode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@rimurucode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@rimurucode-ai/console-core/util/date.js"
import { Identifier } from "@rimurucode-ai/console-core/identifier.js"
...
import { Subscription } from "@rimurucode-ai/console-core/subscription.js"
import { BlackData } from "@rimurucode-ai/console-core/black.js"
import { UserTable } from "@rimurucode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@rimurucode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@rimurucode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@rimurucode-ai/console-core/lite.js"
...
export async function handler(
    ...
    if (modelData.trialEnded)
      throw new ModelError(
        `${t("zen.api.error.trialEnded", {
          ...
          link: "https://github.com/gowdaman-dev/rimuru-ai/go",
        })}`,
      )
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://github.com/gowdaman-dev/rimuru-ai/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://github.com/gowdaman-dev/rimuru-ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://github.com/gowdaman-dev/rimuru-ai/workspace/${authInfo.workspaceID}/members`

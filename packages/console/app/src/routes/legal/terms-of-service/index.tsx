...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Rimuru | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Rimuru AI terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Rimuru. Please read on to learn the rules and restrictions that govern your use of
                Rimuru&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Rimuru AI," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://github.com/gowdaman-dev/rimuru-ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-rimuru">What is Rimuru?</h2>
              <p>
                Rimuru is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Rimuru Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Rimuru enables you to
              ...
              <p>
                ...
                our site located at rimurucode.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Rimuru takes the privacy of its users very seriously. For the current Rimuru Privacy Policy, please
                click here{" "}
                <a href="https://github.com/gowdaman-dev/rimuru-ai/legal/privacy-policy">https://github.com/gowdaman-dev/rimuru-ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Rimuru?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Rimuru;
                </li>
                <li>
              ...
              <p>
                If you use Rimuru with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Rimuru. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Rimuru has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-rimuru-ever-change-the-services">Will Rimuru ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://github.com/gowdaman-dev/rimuru-ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://github.com/gowdaman-dev/rimuru-ai/auth">https://github.com/gowdaman-dev/rimuru-ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://github.com/gowdaman-dev/rimuru-ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Rimuru is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Rimuru has the sole right to decide whether you are
              ...
              <p>
                Rimuru and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Rimuru and all such
                parties together, the "Rimuru Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Rimuru Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Rimuru Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY RIMURU (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                RIMURU PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO RIMURU IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Rimuru Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Rimuru's prior written
              ...
              <p>
                ...
                disputes and claims with Rimuru and limits the manner in which you can seek relief from Rimuru. Both
                you and Rimuru acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Rimuru's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Rimuru will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Rimuru will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Rimuru may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND RIMURU WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Rimuru are instead choosing to have claims and disputes resolved by
                ...
                you and Rimuru over whether to vacate or enforce an arbitration award, YOU AND RIMURU WAIVE ALL
              ...
              <p>
                ...
                Rimuru is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Rimuru to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Rimuru agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Rimuru may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Rimuru agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Rimuru, and
                ...
                are not an employee, agent, partner, or joint venture of Rimuru, and you do not have any authority of
                any kind to bind Rimuru in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Rimuru

...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>Rimuru | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="Rimuru AI privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At Rimuru, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of Rimuru is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://github.com/gowdaman-dev/rimuru-ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the Rimuru website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about Rimuru.
                </li>
              ...
              <p>
                ...
                you, Rimuru or another party; enforcing any agreements with you; responding to claims that any posting

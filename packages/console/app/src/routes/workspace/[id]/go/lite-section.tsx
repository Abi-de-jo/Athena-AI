...
import { Database, eq, and, isNull } from "@rimurucode-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@rimurucode-ai/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#rimuru-go")} target="_blank" rel="noopener noreferrer">

...
export const TypeId: TypeId = "~@rimuru-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@rimuru-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@rimuru-ai/effect-sqlite-node/NodeSqliteClient")

...
export const TypeId: TypeId = "~@rimurucode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@rimurucode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@rimurucode-ai/effect-sqlite-node/NodeSqliteClient")

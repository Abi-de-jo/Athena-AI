import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@rimurucode-ai/sdk/v2"
import { SessionTurn } from "@rimurucode-ai/ui/session-turn"
import { SessionReview } from "@rimurucode-ai/ui/session-review"
import { DataProvider } from "@rimurucode-ai/ui/context"
import { FileComponentProvider } from "@rimurucode-ai/ui/context/file"
import { WorkerPoolProvider } from "@rimurucode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@rimurucode-ai/ui/logo"
import { IconButton } from "@rimurucode-ai/ui/icon-button"
import { ProviderIcon } from "@rimurucode-ai/ui/provider-icon"
...
import { Tabs } from "@rimurucode-ai/ui/tabs"
import { MessageNav } from "@rimurucode-ai/ui/message-nav"
import { FileSSR } from "@rimurucode-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@rimurucode-ai/ui/pierre/worker").then((m) => ({

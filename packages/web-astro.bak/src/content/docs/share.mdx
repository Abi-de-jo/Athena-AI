---
title: Share
description: Share your Rimuru AI conversations.
---

Rimuru AI's share feature allows you to create public links to your Rimuru AI conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Rimuru AI:
...
Rimuru AI supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Rimuru AI uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using rimuru-ai in your organization.

...
description: Crie ferramentas que o LLM pode chamar no rimuru-ai.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do rimuru-ai, como `read`, `write` e `bash`.
...
- Ou globalmente, colocando-as em `~/.config/rimuru-ai/tools/`.

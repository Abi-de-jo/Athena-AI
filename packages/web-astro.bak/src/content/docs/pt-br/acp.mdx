---
title: Suporte ACP
description: Use o rimuru-ai em qualquer editor compatível com ACP.
---

O rimuru-ai suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar rimuru-ai via ACP, configure seu editor para executar o comando `rimuru-ai acp`.

Este comando inicia o rimuru-ai como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'rimuru-ai' no seletor de agentes do AI Chat.
...
Para usar rimuru-ai como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar rimuru-ai como o agente ACP para chat.
...
O rimuru-ai funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do rimuru-ai

---
title: SDK
description: Cliente JS seguro em tipos para o servidor rimuru-ai.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do rimuru-ai fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o rimuru-ai programaticamente.
...
Crie uma instância do rimuru-ai:
...
Se você já tem uma instância do rimuru-ai em execução, pode criar uma instância de cliente para se conectar a ela:

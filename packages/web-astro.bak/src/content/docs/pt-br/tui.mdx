---
title: TUI
description: Usando a interface de usuário de terminal rimuru-ai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O rimuru-ai fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar rimuru-ai inicia o TUI para o diretório atual.
...
Ao usar o TUI do rimuru-ai, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao rimuru-ai. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do rimuru-ai. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Controla por quanto tempo o Rimuru AI espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `rimuru-ai.default`.

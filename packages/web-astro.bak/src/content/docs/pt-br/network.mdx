...
O rimuru-ai suporta variáveis de ambiente de proxy padrão e certificados personalizados para ambientes de rede corporativa.

---

## Proxy

O rimuru-ai respeita variáveis de ambiente de proxy padrão.
...
Se sua empresa usa CAs personalizadas para conexões HTTPS, configure o rimuru-ai para confiá-las.

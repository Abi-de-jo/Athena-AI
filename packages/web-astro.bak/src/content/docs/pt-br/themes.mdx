...
Com o rimuru-ai, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o rimuru-ai usa nosso próprio tema `rimuru-ai`.
...
O rimuru-ai vem com vários temas embutidos.
...
- Querem que o rimuru-ai corresponda à aparência do seu terminal
...
O rimuru-ai suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
...
2. **Diretório de configuração do usuário** - Definido em `~/.config/rimuru-ai/themes/*.json` ou `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

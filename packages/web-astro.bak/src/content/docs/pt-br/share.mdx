---
title: Compartilhar
description: Compartilhe suas conversas do rimuru-ai.
---

O recurso de compartilhamento do rimuru-ai permite que você crie links públicos para suas conversas do rimuru-ai, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o rimuru-ai:
...
O rimuru-ai suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o rimuru-ai usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o rimuru-ai em sua organização.

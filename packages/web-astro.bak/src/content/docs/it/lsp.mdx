---
title: Server LSP
description: Rimuru AI si integra con i tuoi server LSP.
---

Rimuru AI può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Rimuru AI include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e rimuru-ai apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di rimuru-ai.

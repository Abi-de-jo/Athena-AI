---
title: TUI
description: Usa l'interfaccia utente da terminale (TUI) di Rimuru AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI fornisce un'interfaccia interattiva da terminale (TUI) per lavorare sui tuoi progetti con un LLM.

Eseguire Rimuru AI avvia la TUI per la directory corrente.
...
Quando usi la TUI di Rimuru AI, puoi digitare `/` seguito dal nome di un comando per eseguire rapidamente azioni. Per esempio:
...
Aggiunge un provider a Rimuru AI. Ti permette di selezionare tra i provider disponibili e aggiungere le relative chiavi API.
...
Esce da Rimuru AI. _Alias_: `/quit`, `/q`
...
- `leader_timeout` - Controlla per quanto tempo Rimuru AI attende dopo il leader key. Default: `2000`.
...
- `sound_pack` - ID del sound pack da usare. Default: `rimuru-ai.default`.

---
title: SDK
description: Client JS type-safe per il server rimuru-ai.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di rimuru-ai fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare rimuru-ai in modo programmatico.
...
Se hai gia un'istanza di rimuru-ai in esecuzione, puoi creare un client per collegarti:

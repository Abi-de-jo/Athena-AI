...
description: Crea strumenti che l'LLM puo chiamare in rimuru-ai.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di rimuru-ai come `read`, `write` e `bash`.
...
- Oppure in globale, mettendoli in `~/.config/rimuru-ai/tools/`.

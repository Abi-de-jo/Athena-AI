...
Puoi aggiungere comandi personalizzati tramite la config di Rimuru AI o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Rimuru AI:
...
- Globale: `~/.config/rimuru-ai/commands/`
...
rimuru-ai include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).

---
title: Supporto ACP
description: Usa Rimuru AI in qualunque editor compatibile con ACP.
---

Rimuru AI supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare Rimuru AI via ACP, configura l'editor in modo che esegua il comando `rimuru-ai acp`.

Il comando avvia Rimuru AI come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'Rimuru AI' nel selettore agenti di AI Chat.
...
Per usare Rimuru AI come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare Rimuru AI come agente ACP per la chat.
...
Rimuru AI funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione Rimuru AI

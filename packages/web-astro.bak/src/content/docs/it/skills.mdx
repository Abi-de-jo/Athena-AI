...
Le skill degli agenti permettono a Rimuru AI di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
Rimuru AI cerca in queste posizioni:

- Config di progetto: `.opencode/skills/<name>/SKILL.md`
- Config globale: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
Per i percorsi locali al progetto, Rimuru AI risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
Le definizioni globali vengono caricate anche da `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` e `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI elenca le skill disponibili nella descrizione dello strumento `skill`.

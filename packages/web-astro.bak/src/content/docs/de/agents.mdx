...
Es gibt zwei Arten von Agenten in Rimuru AI; Primäragenten und Subagenten.
...
Rimuru AI verfügt über zwei integrierte Primäragenten: **Build** und **Plan**. Auch
...
Wenn keine Temperatur angegeben ist, verwendet Rimuru AI modellspezifische Standardwerte; typischerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle.
...
Dieser Pfad ist relativ zum Speicherort der Konfigurationsdatei. Dies funktioniert sowohl für die globale Rimuru AI-Konfiguration als auch für die projektspezifische Konfiguration.
...
Die Modell-ID in Ihrer Rimuru AI-Konfiguration verwendet das Format `provider/model-id`. Wenn Sie beispielsweise [Rimuru AI Zen](/docs/zen) verwenden, würden Sie `rimuru-ai/gpt-5.1-codex` für GPT 5.1 Codex verwenden.
...
:::tip
Führen Sie `rimuru-ai models` aus, um eine Liste der verfügbaren Modelle anzubieten.
:::
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/gowdaman-dev/rimuru-ai).
:::

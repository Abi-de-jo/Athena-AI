...
Sie können benutzerdefinierte Befehle über die Rimuru AI-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Rimuru AI [config](/docs/config):
...
- Global: `~/.config/rimuru-ai/commands/`
- Pro Projekt: `.opencode/commands/`

```markdown title="~/.config/rimuru-ai/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
Rimuru AI enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).

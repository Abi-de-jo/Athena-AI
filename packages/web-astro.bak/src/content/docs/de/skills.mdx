...
Agent Skills erlauben Rimuru AI, wiederverwendbare Anweisungen aus deinem Repo oder Home-Verzeichnis zu finden.
...
Rimuru AI sucht in folgenden Pfaden:
...
Bei projektlokalen Pfaden laeuft Rimuru AI vom aktuellen Verzeichnis nach oben bis zum Git-Worktree.
...
Globale Definitionen kommen zusaetzlich aus `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` und `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI listet verfuegbare Skills in der Beschreibung des `skill`-Tools.

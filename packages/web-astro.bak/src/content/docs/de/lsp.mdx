---
title: LSP Server
description: Rimuru AI lässt sich in Ihren LSP-Server integrieren.
---

Rimuru AI kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Rimuru AI verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Rimuru AI eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Rimuru AI-Konfiguration aktivieren und anpassen.

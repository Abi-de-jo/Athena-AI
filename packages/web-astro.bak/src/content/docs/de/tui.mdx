---
title: TUI
description: Arbeite mit Rimuru AI in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Rimuru AI die TUI im aktuellen Verzeichnis.
...
In der Rimuru AI-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu Rimuru AI hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Rimuru AI. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange Rimuru AI nach der leader key wartet. Standard ist `2000`.
...
- `sound_pack` - Zu verwendende sound pack ID. Standard ist `rimuru-ai.default`.

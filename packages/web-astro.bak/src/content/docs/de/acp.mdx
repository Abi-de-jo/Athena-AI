...
description: Verwenden Sie Rimuru AI in jedem ACP-kompatiblen Editor.
---

Rimuru AI unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Rimuru AI über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `rimuru-ai acp`.

Der Befehl startet Rimuru AI als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Rimuru AI“ in der AI Chat Agent Selector.
...
Um Rimuru AI als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Rimuru AI als ACP-Agent für den Chat verwendet wird.
...
Rimuru AI funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Rimuru AI-Konfiguration konfiguriert sind

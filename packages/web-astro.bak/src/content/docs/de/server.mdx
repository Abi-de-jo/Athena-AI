---
title: Server
description: Nutze den rimuru-ai-Server ueber HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Der Befehl `rimuru-ai serve` startet einen headless HTTP-Server.
Er stellt einen OpenAPI-Endpunkt bereit, den ein rimuru-ai-Client nutzen kann.
...
Der Benutzername ist standardmaessig `rimuru-ai`, kann aber mit `OPENCODE_SERVER_USERNAME` ueberschrieben werden. Das gilt fuer `rimuru-ai serve` und `rimuru-ai web`.
...
Wenn du `rimuru-ai` startest, werden TUI und Server gestartet.
...
:::tip
Nutze den rimuru-ai-Server, um rimuru-ai programmatisch anzusteuern.
:::

Diese Architektur erlaubt mehrere Clients und programmatische Nutzung.

Mit `rimuru-ai serve` startest du einen eigenstaendigen Server.
Laeuft bereits eine TUI, startet `rimuru-ai serve` trotzdem eine neue Serverinstanz.
...
Dieses Muster nutzen auch die Rimuru AI-[IDE](/docs/ide)-Plugins.
...
Der rimuru-ai-Server stellt folgende APIs bereit.

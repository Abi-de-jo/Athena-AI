...
Mit Rimuru AI kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Rimuru AI das `rimuru-ai`-Theme.
...
Rimuru AI liefert mehrere eingebaute Themes mit.
...
- Rimuru AI optisch ans Terminal anpassen wollen
...
Rimuru AI unterstuetzt ein flexibles JSON-basiertes Theme-System.
...
2. **Benutzer-Config-Verzeichnis** - Definiert in `~/.config/rimuru-ai/themes/*.json` oder `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

---
title: SDK
description: Type-safe JS client for rimuru-ai server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The rimuru-ai JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control rimuru-ai programmatically.
...
Create an instance of rimuru-ai:
...
If you already have a running instance of rimuru-ai, you can create a client instance to connect to it:

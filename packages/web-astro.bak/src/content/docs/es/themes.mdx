...
Con Rimuru AI puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Rimuru AI usa nuestro propio tema `rimuru-ai`.
...
Rimuru AI viene con varios temas integrados.
...
- Quiere que Rimuru AI coincida con la apariencia de su terminal
...
Rimuru AI admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/rimuru-ai/themes/*.json` o `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

...
description: Rimuru AI se integra con sus servidores LSP.
---

Rimuru AI puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Rimuru AI viene con varios servidores LSP integrados para idiomas populares:
...
Cuando LSP está habilitado y rimuru-ai abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración rimuru-ai.

---
title: Servidor
description: Interactuar con el servidor rimuru-ai a través de HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El comando `rimuru-ai serve` ejecuta un servidor HTTP sin cabeza que expone un punto final OpenAPI que un cliente rimuru-ai puede usar.
...
Configure `OPENCODE_SERVER_PASSWORD` para proteger el servidor con autenticación básica HTTP. El nombre de usuario predeterminado es `rimuru-ai`, o configure `OPENCODE_SERVER_USERNAME` para anularlo. Esto se aplica tanto a `rimuru-ai serve` como a `rimuru-ai web`.
...
Cuando ejecuta `rimuru-ai`, inicia un TUI y un servidor. Donde el TUI es el
...
:::tip
Utilice el servidor rimuru-ai para interactuar con rimuru-ai mediante programación.
:::

Esta arquitectura permite que rimuru-ai admita múltiples clientes y le permite interactuar con rimuru-ai mediante programación.

Puede ejecutar `rimuru-ai serve` para iniciar un servidor independiente. Si tienes el
rimuru-ai TUI ejecutándose, `rimuru-ai serve` iniciará un nuevo servidor.
...
El punto final [`/tui`](#tui) se puede utilizar para conducir el TUI a través del servidor. Por ejemplo, puede completar previamente o ejecutar un mensaje. Esta configuración es utilizada por los complementos Rimuru AI [IDE](/docs/ide).
...
El servidor rimuru-ai expone las siguientes API.

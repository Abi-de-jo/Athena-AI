...
Puede agregar comandos personalizados a través de la configuración Rimuru AI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Rimuru AI [config](/docs/config):
...
rimuru-ai incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).

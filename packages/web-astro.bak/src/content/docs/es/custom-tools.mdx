...
description: Cree herramientas que LLM pueda llamar en rimuru-ai.
---

Las herramientas personalizadas son funciones que usted crea y que el LLM puede llamar durante las conversaciones. Trabajan junto con las [herramientas integradas](/docs/tools) de rimuru-ai como `read`, `write` y `bash`.
...
- O de forma global, colocándolos en `~/.config/rimuru-ai/tools/`.

---
title: Soporte ACP
description: Utilice Rimuru AI en cualquier editor compatible con ACP.
---

Rimuru AI admite el [Agent Client Protocol](https://agentclientprotocol.com) o (ACP), lo que le permite usarlo directamente en editores e IDE compatibles.
...
Para usar Rimuru AI a través de ACP, configure su editor para ejecutar el comando `rimuru-ai acp`.

El comando inicia Rimuru AI como un subproceso compatible con ACP que se comunica con su editor a través de JSON-RPC a través de stdio.
...
Para abrirlo, use el nuevo agente 'Rimuru AI' en el selector de agentes de AI Chat.
...
Para usar Rimuru AI como agente ACP en [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), agregue lo siguiente a su configuración de Neovim:
...
Esta configuración configura CodeCompanion para usar Rimuru AI como agente ACP para el chat.
...
Rimuru AI funciona igual a través de ACP que en la terminal. Todas las funciones son compatibles:
...
- Servidores MCP configurados en su configuración Rimuru AI

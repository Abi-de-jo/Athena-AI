...
Rimuru AI admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

Rimuru AI respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure Rimuru AI para confiar en ellas.

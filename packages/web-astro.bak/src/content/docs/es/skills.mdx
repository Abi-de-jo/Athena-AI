...
Las habilidades del agente permiten a Rimuru AI descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Rimuru AI busca estas ubicaciones:

- Configuración del proyecto: `.opencode/skills/<name>/SKILL.md`
- Configuración global: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, Rimuru AI sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
Las definiciones globales también se cargan desde `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI enumera las habilidades disponibles en la descripción de la herramienta `skill`.

---
title: TUI
description: Usando la interfaz de usuario del terminal Rimuru AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Rimuru AI se inicia TUI para el directorio actual.
...
Cuando utilice Rimuru AI TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Rimuru AI. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Rimuru AI. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera Rimuru AI después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `rimuru-ai.default`.

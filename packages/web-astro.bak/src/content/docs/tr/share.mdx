---
title: Paylasim
description: rimuru-ai konusmalarini genel baglantilarla paylasin.
---

rimuru-ai'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda rimuru-ai:
...
rimuru-ai, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak rimuru-ai manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Kurulusunuzda rimuru-ai kullanimi icin [daha fazla bilgi alin](/docs/enterprise).

---
title: SDK
description: rimuru-ai sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

rimuru-ai JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
rimuru-ai'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir rimuru-ai örneği oluşturun:
...
Halihazırda çalışan bir rimuru-ai örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:

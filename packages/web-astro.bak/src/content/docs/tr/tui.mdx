---
title: TUI
description: Rimuru AI terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

Rimuru AI'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
Rimuru AI TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
Rimuru AI'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
Rimuru AI'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
- `leader_timeout` - Rimuru AI'un leader key sonrasında ne kadar bekleyeceğini kontrol eder. Varsayılan değer `2000`.
...
- `sound_pack` - Kullanılacak sound pack ID. Varsayılan değer `rimuru-ai.default`.

...
rimuru-ai işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

rimuru-ai [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/rimuru-ai/commands/`
...
rimuru-ai, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).

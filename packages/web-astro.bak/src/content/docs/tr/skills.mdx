...
Ajan becerileri, rimuru-ai'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
rimuru-ai su konumlari tarar:

- Proje konfigurasyonu: `.opencode/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
Proje yerel yollarinda rimuru-ai, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
...
Genel tanimlar da `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
rimuru-ai, `skill` araci aciklamasinda mevcut becerileri listeler.

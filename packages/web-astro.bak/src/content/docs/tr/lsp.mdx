...
description: Rimuru AI, LSP sunucularınızla bütünleşir.
---

Rimuru AI, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Rimuru AI, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP etkinleştirildiğinde ve rimuru-ai bir dosyayı açtığında:
...
LSP sunucularını, rimuru-ai yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.

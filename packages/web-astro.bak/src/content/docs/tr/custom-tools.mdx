---
title: Özel Araçlar
description: LLM'un rimuru-ai'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. rimuru-ai'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Veya küresel olarak bunları `~/.config/rimuru-ai/tools/` içine yerleştirerek.

...
rimuru-ai, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.

---

## Vekil Sunucu

rimuru-ai respects standard proxy environment variables.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, rimuru-ai'u bunlara güvenecek şekilde yapılandırın.

...
rimuru-ai'da iki tür agent vardır; birincil agent'lar ve alt agent'lar.
...
rimuru-ai, **Build** ve **Plan** olmak üzere iki yerleşik birincil agent ile birlikte gelir. Bunlara aşağıda bakacağız.
...
Rimuru AI, **General**, **Explore** ve **Scout** olmak üzere üç yerleşik alt agent ile birlikte gelir. Buna aşağıda bakacağız.

---

## Yerleşik

Rimuru AI iki yerleşik birincil agent ve üç yerleşik alt agent ile birlikte gelir.
...
Sıcaklık belirtilmezse rimuru-ai modeline özgü varsayılanları kullanır; çoğu model için genellikle 0, Qwen modelleri için 0,55.
...
Bu yol, yapılandırma dosyasının bulunduğu yere göredir. Yani bu hem global rimuru-ai yapılandırması hem de projeye özel yapılandırma için işe yarar.
...
rimuru-ai yapılandırmanızdaki model kimliği `provider/model-id` biçimini kullanır. Örneğin, [Rimuru AI Zen](/docs/zen) kullanıyorsanız, GPT 5.1 Codex için `rimuru-ai/gpt-5.1-codex` kullanırsınız.
...
:::tip
Mevcut modellerin listesini görmek için `rimuru-ai models` komutunu çalıştırın.
:::
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/gowdaman-dev/rimuru-ai).
:::

---
title: LSP Servers
description: Rimuru AI integrates with your LSP servers.
---

Rimuru AI can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Rimuru AI comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and rimuru-ai opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your rimuru-ai config.

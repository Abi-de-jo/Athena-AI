...
U Rimuru AI mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Rimuru AI koristi nasu `rimuru-ai` temu.
...
Rimuru AI dolazi sa vise ugradenih tema.
...
- Zele da Rimuru AI odgovara izgledu njihovog terminala
...
Rimuru AI podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
...
2. **Korisnicki config direktorij** - `~/.config/rimuru-ai/themes/*.json` ili `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

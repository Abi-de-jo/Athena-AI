---
title: Formateri
description: Rimuru AI koristi formatere specifične za jezik.
---

Rimuru AI automatski formatira datoteke nakon što su napisane ili uređene pomoću formatera specifičnih za jezik. Ovo osigurava da kod koji se generira prati stilove koda vašeg projekta.

---

## Ugrađeni

Rimuru AI dolazi sa nekoliko ugrađenih formatera za popularne jezike i okvire. Ispod je lista formatera, podržanih ekstenzija datoteka i naredbi ili opcija konfiguracije koje su mu potrebne.
...
Dakle, ako vaš projekat ima `prettier` u vašem `package.json`, Rimuru AI će ga automatski koristiti.

---

## Kako radi

Kada Rimuru AI piše ili uređuje datoteku, on:
...
Možete prilagoditi formatere kroz `formatter` odjeljak u vašoj Rimuru AI konfiguraciji.

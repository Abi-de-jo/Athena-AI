---
title: TUI
description: Korištenje korisničkog interfejsa Rimuru AI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Rimuru AI pokreće TUI za trenutni direktorij.
...
Kada koristite Rimuru AI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Rimuru AI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Rimuru AI. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo Rimuru AI čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `rimuru-ai.default`.

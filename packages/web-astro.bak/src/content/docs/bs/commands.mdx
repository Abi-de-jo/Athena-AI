...
Možete dodati prilagođene komande kroz Rimuru AI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Rimuru AI [config](/docs/config):
...
- Globalno: `~/.config/rimuru-ai/commands/`
...
Rimuru AI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note

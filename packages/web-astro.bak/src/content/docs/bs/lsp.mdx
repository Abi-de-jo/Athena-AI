---
title: LSP serveri
description: Rimuru AI se integriše sa vašim LSP serverima.
---

Rimuru AI se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Rimuru AI dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i rimuru-ai otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj rimuru-ai konfiguraciji.

...
Agent skills omogucavaju Rimuru AI da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Rimuru AI pretrazuje ove lokacije:

- Konfiguracija projekta: `.opencode/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Rimuru AI ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
Globalne definicije se takoder ucitavaju iz `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI navodi dostupne skills u opisu `skill` alata.

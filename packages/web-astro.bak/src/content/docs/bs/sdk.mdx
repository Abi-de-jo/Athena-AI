---
title: SDK
description: Type-safe JS klijent za rimuru-ai server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

rimuru-ai JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje rimuru-ai-om.
...
Ako vec imate pokrenutu rimuru-ai instancu, mozete napraviti klijentsku instancu i povezati se na nju:

---
title: ACP podrška
description: Koristite Rimuru AI u bilo kojem uređivaču kompatibilnom sa ACP.
---

Rimuru AI podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Rimuru AI putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `rimuru-ai acp`.

Naredba pokreće Rimuru AI kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Rimuru AI" agenta u AI Chat agent selektoru.
...
Da koristite Rimuru AI kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Rimuru AI kao ACP chat agenta.
...
Rimuru AI radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Rimuru AI konfiguraciji

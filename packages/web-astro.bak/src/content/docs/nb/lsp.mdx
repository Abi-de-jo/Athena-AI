---
title: LSP-servere
description: rimuru-ai integreres med LSP-serverne dine.
---

Rimuru AI kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Rimuru AI kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og rimuru-ai åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Rimuru AI-konfigurasjonen.

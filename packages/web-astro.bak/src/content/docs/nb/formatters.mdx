---
title: Formattere
description: Rimuru AI bruker språkspesifikke formattere.
---

Rimuru AI formaterer automatisk filer etter at de er skrevet eller redigert ved hjelp av språkspesifikke formattere. Dette sikrer at koden som genereres følger kodestilene til prosjektet ditt.

---

## Innebygde formattere

Rimuru AI kommer med flere innebygde formattere for populære språk og rammeverk. Nedenfor er en liste over formattere, støttede filendelser og kommandoer eller konfigurasjonsalternativer den krever.
...
Så hvis prosjektet ditt har `prettier` i `package.json`, vil Rimuru AI automatisk bruke det.

---

## Slik fungerer det

Når Rimuru AI skriver eller redigerer en fil, gjør den:
...
Du kan tilpasse formattere gjennom `formatter`-delen i Rimuru AI-konfigurasjonen.

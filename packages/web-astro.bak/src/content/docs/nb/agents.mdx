...
Det er to typer agenter i Rimuru AI; primære agenter og underagenter.
...
Rimuru AI kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Rimuru AI kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Rimuru AI kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Hvis ingen temperatur er spesifisert, bruker Rimuru AI modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Rimuru AI-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Rimuru AI-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Rimuru AI Zen](/docs/zen), vil du bruke `rimuru-ai/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `rimuru-ai models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/gowdaman-dev/rimuru-ai).
:::

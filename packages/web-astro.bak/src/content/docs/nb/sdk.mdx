---
title: SDK
description: Typesikker JS-klient for Rimuru AI-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Rimuru AI JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Rimuru AI programmatisk.
...
Opprett en forekomst av Rimuru AI:
...
Hvis du allerede har en kjørende forekomst av Rimuru AI, kan du opprette en klientforekomst for å koble til den:

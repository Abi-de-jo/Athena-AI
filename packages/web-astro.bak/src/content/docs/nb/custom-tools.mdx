...
description: Lag verktøy som LLM kan kalle inn Rimuru AI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Rimuru AI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Eller globalt, ved å plassere dem i `~/.config/rimuru-ai/tools/`.

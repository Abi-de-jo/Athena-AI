---
title: TUI
description: Bruke rimuru-ai-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Rimuru AI starter TUI for gjeldende katalog.
...
Når du bruker Rimuru AI TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Rimuru AI. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Rimuru AI. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor lenge Rimuru AI venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `rimuru-ai.default`.

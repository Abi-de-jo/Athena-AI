---
title: ACP-støtte
description: Bruk rimuru-ai i en hvilken som helst ACP-kompatibel editor.
---

Rimuru AI støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke Rimuru AI via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `rimuru-ai acp`.

Kommandoen starter Rimuru AI som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'Rimuru AI'-agenten i AI Chat-agentvelgeren.
...
For å bruke Rimuru AI som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke Rimuru AI som ACP-agent for chat.
...
Rimuru AI fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i Rimuru AI-konfigurasjonen

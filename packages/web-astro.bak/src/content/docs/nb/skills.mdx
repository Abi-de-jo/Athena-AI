...
Agentferdigheter lar Rimuru AI oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
rimuru-ai søker etter disse stedene:

- Prosjektkonfigurasjon: `.opencode/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
For prosjektlokale stier går rimuru-ai opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
Globale definisjoner lastes også inn fra `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
rimuru-ai viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.

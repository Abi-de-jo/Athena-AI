---
title: Tjener
description: Samhandle med Rimuru AI-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `rimuru-ai serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en Rimuru AI-klient kan bruke.
...
Sett `OPENCODE_SERVER_PASSWORD` for å beskytte serveren med HTTP grunnleggende autentisering. Brukernavnet er satt til `rimuru-ai` som standard, eller sett `OPENCODE_SERVER_USERNAME` for å overstyre det. Dette gjelder både `rimuru-ai serve` og `rimuru-ai web`.
...
Når du kjører `rimuru-ai` starter den en TUI og en server. Der TUI er
...
:::tip
Bruk Rimuru AI-serveren til å samhandle med Rimuru AI programmatisk.
:::

Denne arkitekturen lar Rimuru AI støtte flere klienter og lar deg samhandle med Rimuru AI programmatisk.

Du kan kjøre `rimuru-ai serve` for å starte en frittstående server. Hvis du har
Rimuru AI TUI kjører, vil `rimuru-ai serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av Rimuru AI [IDE](/docs/ide) plugins.
...
rimuru-ai-serveren viser følgende APIer.

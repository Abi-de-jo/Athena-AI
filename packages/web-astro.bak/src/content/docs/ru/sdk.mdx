---
title: SDK
description: Типобезопасный JS-клиент для сервера rimuru-ai.
---
...
Если у вас уже есть работающий экземпляр rimuru-ai, вы можете создать экземпляр клиента для подключения к нему:

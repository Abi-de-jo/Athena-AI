...
rimuru-ai имеет список сочетаний клавиш, которые вы можете настроить через `tui.json`.
...
rimuru-ai использует клавишу `leader` для большинства сочетаний клавиш. Это позволяет избежать конфликтов в вашем терминале.
...
Ввод приглашения настольного приложения rimuru-ai поддерживает распространенные сочетания клавиш в стиле Readline/Emacs для редактирования текста. Они встроены и в настоящее время не настраиваются через `opencode.json`.

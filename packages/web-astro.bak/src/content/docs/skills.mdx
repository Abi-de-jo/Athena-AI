...
Agent skills let Rimuru AI discover reusable instructions from your repo or home directory.
...
Rimuru AI searches these locations:
...
For project-local paths, Rimuru AI walks up from your current working directory until it reaches the git worktree.
...
Global definitions are also loaded from `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md`, and `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI lists available skills in the `skill` tool description.

...
Rimuru AI มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
Rimuru AI มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
Rimuru AI มี subagent ในตัวได้แก่ **General**, **Explore** และ **Scout** ดูรายละเอียดด้านล่าง

---

## บิวท์อิน

Rimuru AI มาพร้อมกับเอเจนต์หลัก 2 ตัวและ subagent ในตัว 3 ตัว
...
เอเจนต์แบบอ่านอย่างเดียวสำหรับค้นคว้าเอกสารภายนอกและ dependency ใช้สิ่งนี้เมื่อคุณต้องการ clone repository ของ dependency เข้าไปใน cache ที่ Rimuru AI จัดการให้, ตรวจสอบ source code ของไลบรารี, หรือเทียบโค้ดในเครื่องกับ implementation จาก upstream โดยไม่แก้ไข workspace ของคุณ
...
- ระดับผู้ใช้ (Global): `~/.config/rimuru-ai/agents/`
...
หมายเหตุ: Rimuru AI ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ Rimuru AI
:::
...
:::tip
ใช้ `rimuru-ai models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/gowdaman-dev/rimuru-ai)
:::

---
title: TUI
description: การใช้อินเทอร์เฟซผู้ใช้ terminal Rimuru AI
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI มีอินเทอร์เฟซ terminal แบบโต้ตอบหรือ TUI สำหรับการทำงานในโครงการของคุณด้วย LLM

การรัน Rimuru AI จะเริ่มต้น TUI สำหรับไดเร็กทอรีปัจจุบัน
...
เมื่อใช้ Rimuru AI TUI คุณสามารถพิมพ์ `/` ตามด้วยชื่อคำสั่งเพื่อดำเนินการอย่างรวดเร็ว ตัวอย่างเช่น:
...
เพิ่มผู้ให้บริการให้กับ Rimuru AI ให้คุณเลือกจากผู้ให้บริการที่มีอยู่และเพิ่มคีย์ API
...
ออกจาก Rimuru AI _นามแฝง_: `/quit`, `/q`
...
- `leader_timeout` - ควบคุมระยะเวลาที่ Rimuru AI จะรอหลังจากกด leader key ค่าเริ่มต้นคือ `2000`
...
- `sound_pack` - sound pack ID ที่จะใช้ ค่าเริ่มต้นคือ `rimuru-ai.default`

...
คุณสามารถเพิ่มเครื่องมือภายนอกให้กับ Rimuru AI ได้โดยใช้ _Model Context Protocol_ หรือ MCP Rimuru AI รองรับทั้งเซิร์ฟเวอร์ภายในและเซิร์ฟเวอร์ระยะไกล
...
คุณสามารถกำหนดเซิร์ฟเวอร์ MCP ได้ใน [Rimuru AI Config](https://rimurucode.vercel.app/docs/config/) ภายใต้ `mcp` เพิ่ม MCP แต่ละรายการด้วยชื่อที่ไม่ซ้ำใคร คุณสามารถอ้างอิงถึง MCP ด้วยชื่อได้เมื่อแจ้ง LLM
...
Rimuru AI จะจัดการการตรวจสอบสิทธิ์ OAuth สำหรับเซิร์ฟเวอร์ MCP ระยะไกลโดยอัตโนมัติ เมื่อเซิร์ฟเวอร์ต้องการการรับรองความถูกต้อง Rimuru AI จะ:
...
หากเซิร์ฟเวอร์ต้องมีการตรวจสอบสิทธิ์ Rimuru AI จะแจ้งให้คุณตรวจสอบความถูกต้องเมื่อคุณพยายามใช้งานครั้งแรก หากไม่เป็นเช่นนั้น คุณสามารถ[ทริกเกอร์โฟลว์ด้วยตนเอง](#การตรวจสอบสิทธิ์) ด้วย `rimuru-ai mcp auth <server-name>`
...
คำสั่ง `mcp auth` จะเปิดเบราว์เซอร์ของคุณเพื่อขออนุญาต หลังจากที่คุณอนุญาตแล้ว Rimuru AI จะจัดเก็บโทเค็นอย่างปลอดภัยใน `~/.local/share/rimuru-ai/mcp-auth.json`
...
MCP ของคุณพร้อมใช้งานในฐานะเครื่องมือใน Rimuru AI ควบคู่ไปกับเครื่องมือในตัว คุณจึงสามารถจัดการผ่านการกำหนดค่า Rimuru AI ได้เหมือนกับเครื่องมืออื่นๆ
...
ซึ่งจะเป็นการเปิดหน้าต่างเบราว์เซอร์เพื่อดำเนินการโฟลว์ OAuth ให้เสร็จสมบูรณ์ และเชื่อมต่อ Rimuru AI กับบัญชี Sentry ของคุณ

...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Rimuru AI:
...
- ระดับผู้ใช้ (Global): `~/.config/rimuru-ai/commands/`
...
Rimuru AI มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)

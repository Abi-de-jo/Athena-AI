...
ทักษะของเจ้าหน้าที่ช่วยให้ Rimuru AI ค้นพบคำแนะนำที่ใช้ซ้ำได้จาก repo หรือโฮมไดเร็กทอรีของคุณ
...
Rimuru AI ค้นหาตำแหน่งเหล่านี้:

- การกำหนดค่าโครงการ: `.opencode/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
สำหรับเส้นทางภายในโปรเจ็กต์ Rimuru AI จะเดินขึ้นมาจากไดเร็กทอรีการทำงานปัจจุบันของคุณจนกว่าจะถึงแผนผังงาน git
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.opencode/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
Rimuru AI แสดงรายการทักษะที่มีอยู่ในคำอธิบายเครื่องมือ `skill`

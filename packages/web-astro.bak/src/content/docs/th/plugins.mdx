---
title: ปลั๊กอิน
description: เขียนปลั๊กอินของคุณเองเพื่อขยาย Rimuru AI
---

ปลั๊กอินช่วยให้คุณสามารถขยาย Rimuru AI ได้โดยเชื่อมโยงกับเหตุการณ์ต่างๆ และปรับแต่งลักษณะการทำงาน คุณสามารถสร้างปลั๊กอินเพื่อเพิ่มคุณสมบัติใหม่ บูรณาการกับบริการภายนอก หรือแก้ไขการทำงานเริ่มต้นของ Rimuru AI
...
- `~/.config/rimuru-ai/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/rimuru-ai/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/rimuru-ai/opencode.json`)
2. การกำหนดค่าโครงการ (`opencode.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/rimuru-ai/plugins/`)
...
Rimuru AI รัน `bun install` เมื่อเริ่มต้นเพื่อติดตั้งสิ่งเหล่านี้ ปลั๊กอินและเครื่องมือของคุณสามารถนำเข้าได้
...
- `client`: ไคลเอนต์ rimuru-ai SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย rimuru-ai
...
:::note
หากคุณใช้แอปเดสก์ท็อป Rimuru AI แอปสามารถส่งการแจ้งเตือนของระบบโดยอัตโนมัติเมื่อมีการตอบกลับพร้อมหรือเมื่อเซสชันเกิดข้อผิดพลาด
:::
...
ป้องกันไม่ให้ rimuru-ai อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ rimuru-ai:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ rimuru-ai ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ rimuru-ai ควบคู่ไปกับเครื่องมือในตัว
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://rimurucode.vercel.app/docs/sdk)สำหรับรายละเอียด

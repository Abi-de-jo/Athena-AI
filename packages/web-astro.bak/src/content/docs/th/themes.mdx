...
ด้วย Rimuru AI คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น Rimuru AI จะใช้ธีม `rimuru-ai` ของเราเอง
...
Rimuru AI มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ Rimuru AI ตรงกับรูปลักษณ์ของ terminal
...
Rimuru AI รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/rimuru-ai/themes/*.json` หรือ `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

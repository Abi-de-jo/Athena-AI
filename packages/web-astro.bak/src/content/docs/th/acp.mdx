---
title: การรองรับ ACP
description: ใช้ Rimuru AI ในโปรแกรมแก้ไขที่รองรับ ACP
---

Rimuru AI รองรับ [Agent Client Protocol](https://agentclientprotocol.com) (ACP) ซึ่งช่วยให้สามารถทำงานร่วมกับ editor และ IDE ต่างๆ ได้โดยตรง
...
ในการใช้ Rimuru AI ผ่าน ACP ให้กำหนดค่าโปรแกรมแก้ไขของคุณให้รันคำสั่ง `rimuru-ai acp`

คำสั่งนี้จะเริ่ม Rimuru AI เป็น process ย่อยที่รองรับ ACP ซึ่งสื่อสารกับโปรแกรมแก้ไขของคุณผ่าน JSON-RPC ทาง stdio
...
นี่เป็นการเปิดให้ตัวแทน 'Rimuru AI' ในเนื้อหาของตัวแทน AI Chat
...
ลองใช้ Rimuru AI ACP ใน [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) ให้เพิ่มสิ่งต่อไปนี้ใน Neovim ของคุณ:
...
คุณสามารถใช้ CodeCompanion เพื่อใช้ rimuru-ai เป็น ACP agent สำหรับแชท
...
rimuru-ai ทำงานผ่าน ACP เหมือนกับใน terminal และรองรับฟีเจอร์ทั้งหมด:
...
- MCP แขกที่นี่คือข้อมูลเพิ่มเติมของ Rimuru AI ของคุณ

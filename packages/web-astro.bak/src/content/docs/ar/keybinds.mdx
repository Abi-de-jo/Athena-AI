...
يوفّر Rimuru AI قائمة باختصارات لوحة المفاتيح يمكنك تخصيصها عبر إعدادات Rimuru AI.
...
يستخدم Rimuru AI مفتاح `leader` لمعظم اختصارات لوحة المفاتيح. يساعد ذلك على تجنّب التعارضات في terminal لديك.
...
يدعم حقل إدخال الموجّه في تطبيق Rimuru AI لسطح المكتب اختصارات شائعة لتحرير النص على نمط Readline/Emacs. هذه الاختصارات مدمجة حاليا ولا يمكن تخصيصها عبر `opencode.json`.

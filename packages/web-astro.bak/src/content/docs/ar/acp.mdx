---
title: دعم ACP
description: استخدم Rimuru AI في أي محرر متوافق مع ACP.
---

يدعم Rimuru AI بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Rimuru AI عبر ACP، اضبط محررك ليشغّل الأمر `rimuru-ai acp`.

يشغّل هذا الأمر Rimuru AI كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Rimuru AI' من محدد الوكلاء في AI Chat.
...
لاستخدام Rimuru AI كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Rimuru AI كوكيل ACP للدردشة.
...
يعمل Rimuru AI عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Rimuru AI

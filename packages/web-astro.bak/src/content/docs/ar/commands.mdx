...
يمكنك إضافة أوامر مخصصة عبر إعدادات Rimuru AI أو بإنشاء ملفات Markdown داخل الدليل `commands/`.

---

### JSON

استخدم خيار `command` في [config](/docs/config) الخاص بـ Rimuru AI:
...
- على مستوى النظام: `~/.config/rimuru-ai/commands/`
...
يتضمن rimuru-ai عدة أوامر مضمنة مثل `/init` و`/undo` و`/redo` و`/share` و`/help`؛ [اعرف المزيد](/docs/tui#commands).

---
title: TUI
description: استخدام واجهة المستخدم TUI في Rimuru AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Rimuru AI واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Rimuru AI إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Rimuru AI في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Rimuru AI. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Rimuru AI. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار Rimuru AI بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `rimuru-ai.default`.

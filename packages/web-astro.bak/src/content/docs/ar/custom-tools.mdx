...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في rimuru-ai.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في rimuru-ai مثل `read` و`write` و`bash`.
...
- أو عالميا بوضعها في `~/.config/rimuru-ai/tools/`.

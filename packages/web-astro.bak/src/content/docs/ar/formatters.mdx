---
title: المُنسِّقات
description: يستخدم Rimuru AI مُنسِّقات خاصة بكل لغة.
---

يُنسِّق Rimuru AI الملفات تلقائيا بعد كتابتها أو تعديلها باستخدام مُنسِّقات خاصة بكل لغة. يضمن ذلك أن الشيفرة التي يتم توليدها تتبع أساليب التنسيق المعتمدة في مشروعك.

---

## مُضمَّنة

يأتي Rimuru AI مع عدة مُنسِّقات مُضمَّنة للغات وأطر العمل الشائعة. فيما يلي قائمة بالمُنسِّقات وامتدادات الملفات المدعومة والأوامر أو خيارات الإعداد التي تحتاجها.
...
لذا إذا كان مشروعك يتضمن `prettier` ضمن `package.json`، فسيستخدمه Rimuru AI تلقائيا.

---

## كيف يعمل

عندما يكتب Rimuru AI ملفا أو يحرره، فإنه:
...
يمكنك تخصيص المُنسِّقات عبر قسم `formatter` في إعدادات Rimuru AI.

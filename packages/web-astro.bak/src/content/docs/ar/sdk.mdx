...
description: عميل JavaScript آمن الأنواع لخادم rimuru-ai.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

توفر SDK الخاصة بـ rimuru-ai لـ JS/TS عميلا آمنا للأنواع للتفاعل مع الخادم.
استخدمها لبناء التكاملات والتحكم في rimuru-ai برمجيا.
...
إذا كان لديك مثيل rimuru-ai يعمل بالفعل، يمكنك إنشاء مثيل عميل للاتصال به:

...
تتيح مهارات الوكيل لـ Rimuru AI اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
يبحث Rimuru AI في هذه المواقع:

- إعدادات المشروع: `.opencode/skills/<name>/SKILL.md`
- إعدادات عامة: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
بالنسبة لمسارات المشروع المحلية، يتدرج Rimuru AI صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
كما تُحمَّل التعريفات العامة أيضاً من `~/.config/rimuru-ai/skills/*/SKILL.md` و `~/.claude/skills/*/SKILL.md` و `~/.agents/skills/*/SKILL.md`.
...
يعرض Rimuru AI المهارات المتاحة في وصف أداة `skill`.

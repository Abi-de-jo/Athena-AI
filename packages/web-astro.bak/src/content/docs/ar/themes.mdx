...
مع Rimuru AI يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم Rimuru AI سمتنا `rimuru-ai`.
...
يأتي Rimuru AI مع عدة سمات مدمجة.
...
- يريدون أن يطابق Rimuru AI مظهر terminal لديهم
...
يدعم Rimuru AI نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/rimuru-ai/themes/*.json` أو `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

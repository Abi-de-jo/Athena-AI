---
title: خوادم LSP
description: يتكامل Rimuru AI مع خوادم LSP لديك.
---

يمكن أن يتكامل Rimuru AI مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Rimuru AI مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح rimuru-ai لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات rimuru-ai.

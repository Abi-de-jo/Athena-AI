...
rimuru-ai obsługa standardowego zmiennego proxy i certyfikatów dla usług sieciowych przedsiębiorstw.

---

## Pełnomocnik

rimuru-ai respektuje standardowe zmienne środowiskowe proxy.
...
Jeśli Twoje przedsiębiorstwo korzysta z niestandardowych usług, urzędów dostępu do HTTPS, skonfiguruj rimuru-ai tak, aby im ufać.

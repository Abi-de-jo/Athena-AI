---
title: Serwery LSP
description: Rimuru AI integruje się z serwerami LSP.
---

Rimuru AI może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Rimuru AI posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Rimuru AI otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Rimuru AI.

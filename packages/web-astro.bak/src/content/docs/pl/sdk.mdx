---
title: SDK
description: Typowany klient JS dla serwera Rimuru AI.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS Rimuru AI zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli Rimuru AI.
...
Jeśli masz już działającą instancję Rimuru AI, możesz utworzyć instancję klienta, aby się z nią połączyć:

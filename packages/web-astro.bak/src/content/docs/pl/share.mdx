---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące rimuru-ai.
---

Funkcja udostępniania rimuru-ai umożliwia tworzenie publicznych linków do konwersacji rimuru-ai, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, rimuru-ai:
...
rimuru-ai obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie rimuru-ai korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
[Dowiedz się więcej](/docs/enterprise) o używaniu rimuru-ai w Twojej organizacji.

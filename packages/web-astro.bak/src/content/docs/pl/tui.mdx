---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala rimuru-ai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

rimuru-ai zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie rimuru-ai uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI rimuru-ai, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do rimuru-ai. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij rimuru-ai. _Aliasy_: `/quit`, `/q`
...
- `leader_timeout` - Określa, jak długo Rimuru AI czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `rimuru-ai.default`.

...
Umiejętności agenta pozwalają rimuru-ai odkryć instrukcje wielokrotnego użytku z repozytorium lub katalogu domowego.
...
rimuru-ai przeszukuje te lokalizacje:

- Project config: `.opencode/skills/<name>/SKILL.md`
- Global config: `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
W przypadku ścieżek lokalnych projektu rimuru-ai przechodzi od bieżącego katalogu roboczego, aż dotrze do drzewa roboczego git.
...
Ładowane są także definicje globalne z `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
rimuru-ai wymienia dostępne umiejętności w opisie narzędzia `skill`.

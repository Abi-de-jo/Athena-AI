...
Narzędzia specjalistyczne to funkcje, które tworzysz i które LLM może wywoływać podczas rozmów. Współpracują one z [wbudowanymi narzędziami](/docs/tools) rimuru-ai, takimi jak `read`, `write` i `bash`.
...
- Lub globalnie, umieszczając je w `~/.config/rimuru-ai/tools/`.

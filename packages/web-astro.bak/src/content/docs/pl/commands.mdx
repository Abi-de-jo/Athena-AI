...
Użyj opcji `command` w swojej konfiguracji rimuru-ai:
...
- Globalnie: `~/.config/rimuru-ai/commands/`
...
rimuru-ai zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).

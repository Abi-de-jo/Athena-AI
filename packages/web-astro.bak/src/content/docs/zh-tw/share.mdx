---
title: 分享
description: 分享您的 Rimuru AI 對話。
---

Rimuru AI 的分享功能允許您建立指向 Rimuru AI 對話的公開連結，方便與團隊成員協作或向他人尋求幫助。
...
Rimuru AI 支援三種分享模式，用於控制對話的共享方式：

---

### 手動模式（預設）

預設情況下，Rimuru AI 使用手動分享模式。工作階段不會自動共享，但您可以使用 `/share` 指令手動分享：
...
[了解更多](/docs/enterprise)關於在您的組織中使用 Rimuru AI 的資訊。

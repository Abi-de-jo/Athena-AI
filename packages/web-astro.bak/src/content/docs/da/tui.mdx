---
title: TUI
description: Brug af Rimuru AI-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Rimuru AI giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Rimuru AI starter TUI for den nuværende mappe.
...
Når du bruger Rimuru AI TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Rimuru AI. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Rimuru AI. _Aliaser_: `/quit`, `/q`
...
- `leader_timeout` - Styrer hvor længe Rimuru AI venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `rimuru-ai.default`.

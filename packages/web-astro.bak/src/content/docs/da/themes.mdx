...
Med Rimuru AI kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Rimuru AI vårt eget `rimuru-ai`-tema.
...
Rimuru AI støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/rimuru-ai/themes/*.json` eller `$XDG_CONFIG_HOME/rimuru-ai/themes/*.json`

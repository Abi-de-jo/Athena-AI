...
Rimuru AI understøtter standard proxymiljøvariabler og brugerdefinerede certifikater til virksomhedsnetværksmiljøer.

---

## Proxy

Rimuru AI respekterer standard proxy-miljøvariabler.
...
Hvis din virksomhed bruger tilpassede CA'er til HTTPS-forbindelser, skal du konfigurere Rimuru AI til at stole på dem.

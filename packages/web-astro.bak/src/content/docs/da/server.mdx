---
title: Server
description: Interager med rimuru-ai-serveren over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `rimuru-ai serve` kører en hovedløs HTTP-server, som afslører et OpenAPI-endpoint, som en rimuru-ai-klient kan bruge.
...
Indstil `OPENCODE_SERVER_PASSWORD` for at beskytte serveren med HTTP grundlæggende godkendelse. Brugernavnet er som standard `rimuru-ai`, eller indstil `OPENCODE_SERVER_USERNAME` for at tilsidesætte det. Dette gælder både `rimuru-ai serve` og `rimuru-ai web`.
...
Når du kører `rimuru-ai` starter den en TUI og en server. Hvor TUI er
...
:::tip
Brug rimuru-ai-serveren til at interagere med rimuru-ai programmatisk.
:::

Denne arkitektur lader rimuru-ai understøtte flere klienter og lader dig interagere med rimuru-ai programmatisk.

Du kan køre `rimuru-ai serve` for at starte en selvstændig server. Hvis du har
rimuru-ai TUI kørende, vil `rimuru-ai serve` starte en ny server.
...
[`/tui`](#tui) endpointet kan bruges til at køre TUI gennem serveren. Du kan for eksempel forududfylde eller køre en forespørgsel. Denne opsætning bruges af Rimuru AI [IDE](/docs/ide) plugins.
...
Rimuru AI-serveren viser følgende API'er.

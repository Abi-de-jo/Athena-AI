...
Der er to typer agenter i Rimuru AI; primære agenter og subagenter.
...
Rimuru AI leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Rimuru AI leveres med tre indbyggede subagenter, **General**, **Explore** og **Scout**. Vi ser nærmere på dem nedenfor.

---

## Indbyggede

Rimuru AI leveres med to indbyggede primære agenter og tre indbyggede subagenter.
...
En skrivebeskyttet agent til eksterne docs og research af dependencies. Brug denne, når du har brug for at klone et dependency-repository ind i Rimuru AI's administrerede cache, inspicere kildekoden i et bibliotek eller krydstjekke lokal kode mod upstream-implementeringer uden at ændre dit workspace.
...
- Globalt: `~/.config/rimuru-ai/agents/`
...
Hvis ingen temperatur er angivet, bruger Rimuru AI modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Rimuru AI-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Rimuru AI-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Rimuru AI Zen](/docs/zen), vil du bruge `rimuru-ai/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `rimuru-ai models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/gowdaman-dev/rimuru-ai).
:::

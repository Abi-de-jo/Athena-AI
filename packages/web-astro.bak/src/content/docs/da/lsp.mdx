---
title: LSP-servere
description: Rimuru AI integreres med dine LSP-servere.
---

Rimuru AI kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Rimuru AI leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og rimuru-ai åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din rimuru-ai-konfiguration.

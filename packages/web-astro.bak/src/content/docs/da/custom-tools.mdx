...
description: Opret værktøjer, som LLM kan kalde rimuru-ai ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med rimuru-ais [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Eller globalt ved at placere dem i `~/.config/rimuru-ai/tools/`.

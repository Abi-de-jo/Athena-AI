...
カスタムコマンドは、Rimuru AI 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Rimuru AI [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/rimuru-ai/commands/`
...
Rimuru AI には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。

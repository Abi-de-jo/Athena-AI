---
title: カスタムツール
description: LLM が Rimuru AI で呼び出すことができるツールを作成します。
---

カスタムツールは、会話中に LLM が呼び出すことができる作成した関数です。これらは、Rimuru AI の[組み込みツール](/docs/tools) (`read`、`write`、`bash` など) と連携して動作します。
...
- または、グローバルに、それらを `~/.config/rimuru-ai/tools/` に配置します。

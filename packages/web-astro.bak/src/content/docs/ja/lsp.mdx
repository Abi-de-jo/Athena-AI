---
title: LSPサーバー
description: Rimuru AI は LSP サーバーと統合します。
---

Rimuru AI は Language Server Protocol (LSP) サーバーと統合し、診断を agent へのフィードバックとして使用できます。

---

## 組み込み

Rimuru AI には、一般的な言語用のいくつかの組み込み LSP サーバーが付属しています。
...
LSP が有効で Rimuru AI がファイルを開くと、次のようになります。
...
Rimuru AI 設定の `lsp` セクションを通じて LSP サーバーを有効化し、カスタマイズできます。

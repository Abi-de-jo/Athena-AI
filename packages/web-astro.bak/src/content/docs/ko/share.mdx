---
title: 공유
description: Rimuru AI 대화를 공유하세요.
---

rimuru-ai의 공유 기능은 rimuru-ai 대화에 대한 공개 링크를 만들 수 있으므로 Teammates와 협업하거나 다른 곳에서 도움을받을 수 있습니다.
...
rimuru-ai는 대화가 공유되는 방법을 제어하는 세 가지 공유 모드를 지원합니다.

---

## 수동 (기본)

기본적으로 rimuru-ai는 수동 공유 모드를 사용합니다. 세션은 자동으로 공유되지 않지만 `/share` 명령을 사용하여 수동으로 공유 할 수 있습니다.
...
[Learn more](/docs/enterprise) 귀하의 조직에서 rimuru-ai를 사용하여.

---
title: SDK
description: Client JS de type sécurisé pour le serveur rimuru-ai.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Le SDK rimuru-ai JS/TS fournit un client de type sécurisé pour interagir avec le serveur.
Utilisez-le pour créer des intégrations et contrôler rimuru-ai par programme.
...
Créez une instance de rimuru-ai :
...
Si vous disposez déjà d'une instance en cours d'exécution de rimuru-ai, vous pouvez créer une instance client pour vous y connecter :

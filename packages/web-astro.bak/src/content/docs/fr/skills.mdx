...
Les compétences d'agent permettent à Rimuru AI de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
Rimuru AI recherche ces emplacements :

- Configuration du projet : `.opencode/skills/<name>/SKILL.md`
- Configuration globale : `~/.config/rimuru-ai/skills/<name>/SKILL.md`
...
Pour les chemins locaux du projet, Rimuru AI remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
Les définitions globales sont également chargées à partir de `~/.config/rimuru-ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` et `~/.agents/skills/*/SKILL.md`.
...
Rimuru AI répertorie les compétences disponibles dans la description de l'outil `skill`.

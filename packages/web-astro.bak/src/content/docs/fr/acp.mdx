---
title: Support ACP
description: Utilisez Rimuru AI dans n’importe quel éditeur compatible ACP.
---

Rimuru AI prend en charge le [Agent Client Protocol](https://agentclientprotocol.com) (ACP), vous permettant de l'utiliser directement dans les éditeurs et IDE compatibles.
...
Pour utiliser Rimuru AI via ACP, configurez votre éditeur pour exécuter la commande `rimuru-ai acp`.

La commande démarre Rimuru AI en tant que sous-processus compatible ACP qui communique avec votre éditeur via JSON-RPC sur stdio.
...
Pour l'ouvrir, utilisez le nouvel agent « Rimuru AI » dans le sélecteur d'agent AI Chat.
...
Pour utiliser Rimuru AI comme agent ACP dans [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), ajoutez ce qui suit à votre configuration Neovim :
...
Cette configuration configure CodeCompanion pour utiliser Rimuru AI comme agent ACP pour le chat.
...
Rimuru AI fonctionne de la même manière via ACP que dans le terminal. Toutes les fonctionnalités sont prises en charge :
...
- Serveurs MCP configurés dans votre configuration Rimuru AI

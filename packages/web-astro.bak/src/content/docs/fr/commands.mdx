...
Vous pouvez ajouter des commandes personnalisées via la configuration Rimuru AI ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Rimuru AI [config](/docs/config) :
...
rimuru-ai comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).

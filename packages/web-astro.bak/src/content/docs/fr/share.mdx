---
title: Partager
description: Partagez vos conversations Rimuru AI.
---

La fonctionnalité de partage de Rimuru AI vous permet de créer des liens publics vers vos conversations Rimuru AI, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, Rimuru AI :
...
Rimuru AI prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, Rimuru AI utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :
...
[En savoir plus](/docs/enterprise) sur l'utilisation de rimuru-ai dans votre organisation.

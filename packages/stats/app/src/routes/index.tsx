...
import {
  ...
  type TokenCostEntry,
  type UsagePoint,
} from "@rimurucode-ai/stats-core/domain/home"
...
const statsHomeTitle = "Rimuru Data"
const statsHomeDescription = "Rimuru usage data, market share, token cost, and session cost."
const statsHomeFallbackUrl = "https://github.com/gowdaman-dev/rimuru-ai/data/"
const statsUnfurlPath = "banner.jpg"
const statsUnfurlAlt = "Rimuru Data wordmark on a dark patterned background"
const usageColors = [
  "#ed6aff",
  "#a684ff",
  "#7c86ff",
...
export default function StatsHome() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Rimuru" />
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.opencode.ai") return "https://github.com/gowdaman-dev/rimuru-ai/data/"
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across Rimuru Go.</span>
      </h2>
      <Show

...
import { SlimeThinking, SlimeThought } from "../../component/slime-thinking"
...
import { RIMURU_BASE_MODE, useBindings, useCommandShortcut, useRimuruKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["rimuru-ai", "opencode-go"])
  ...
  return (
    <Switch>
      <Match when={!props.done}>
        <SlimeThinking text={props.title ? "Thinking: " + props.title : "Thinking"} />
      </Match>
      <Match when={true}>
        <SlimeThought

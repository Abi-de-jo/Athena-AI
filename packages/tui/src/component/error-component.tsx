...
export function ErrorComponent(props: { error: Error; reset: () => void; mode?: "dark" | "light" }) {
  ...
  const issueURL = new URL("https://github.com/gowdaman-dev/rimuru-ai/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("rimuru-version", InstallationVersion)

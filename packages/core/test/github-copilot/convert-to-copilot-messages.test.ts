import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@rimurucode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"

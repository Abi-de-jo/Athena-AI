...
import { ProviderPlugins } from "@rimurucode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@rimurucode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/gowdaman-dev/rimuru-ai/", "X-Title": "rimuru-ai" })

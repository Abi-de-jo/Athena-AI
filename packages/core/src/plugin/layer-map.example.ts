...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@rimuru/example/RequestContextRef",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@rimuru/example/ConfigServiceMap", {

...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServerV1.Server).annotate({
    description: "Server configuration for rimuru-ai serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://github.com/gowdaman-dev/rimuru-ai/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://github.com/gowdaman-dev/rimuru-ai/docs/agents" }),

export * as Rimuru from "./opencode"
...
/** Intentional public native API for Effect applications embedding Rimuru. */
export class Service extends Context.Service<Service, Interface>()("@rimuru/public/Rimuru") {}
...
>()("@rimuru/public/Rimuru/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("Rimuru.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("Rimuru.sessions.switchModel")(function* (input) {
...
// TODO: Add Rimuru.create(...) as the Promise facade over the same native API semantics.

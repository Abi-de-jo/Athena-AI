...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@rimurucode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@rimuru/v2/ToolRegistry") {}

...
# 패키지 매니저
npm i -g rimuru-ai@latest        # bun/pnpm/yarn 도 가능
scoop install rimuru-ai             # Windows
choco install rimuru-ai             # Windows
brew install gowdaman/tap/rimuru-ai # macOS 및 Linux (권장, 항상 최신)
brew install rimuru-ai              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S rimuru-ai            # Arch Linux (Stable)
paru -S rimuru-ai-bin               # Arch Linux (Latest from AUR)
mise use -g rimuru-ai               # 어떤 OS든
nix run nixpkgs#rimuru-ai           # 또는 github:gowdaman/rimuru-ai 로 최신 dev 브랜치
```
...
Rimuru AI 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://rimurucode.vercel.app/docs/agents) 에 대해 더 알아보세요.

### 문서

Rimuru AI 설정에 대한 자세한 내용은 [**문서**](https://rimurucode.vercel.app/docs) 를 참고하세요.

### 기여하기

Rimuru AI 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### Rimuru AI 기반으로 만들기

Rimuru AI 와 관련된 프로젝트를 진행하면서 이름에 "rimuru-ai"(예: "rimuru-ai-dashboard" 또는 "rimuru-ai-mobile") 를 포함한다면, README 에 해당 프로젝트가 Rimuru AI 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/rimuru-ai) | [X.com](https://x.com/rimuru-ai)

...
brew install gowdaman/tap/rimuru-ai # macOS 和 Linux（推荐，始终保持最新）
brew install rimuru-ai              # macOS 和 Linux（官方 brew formula，更新频率较低）
sudo pacman -S rimuru-ai            # Arch Linux (Stable)
paru -S rimuru-ai-bin               # Arch Linux (Latest from AUR)
mise use -g rimuru-ai               # 任意系统
nix run nixpkgs#rimuru-ai           # 或用 github:gowdaman/rimuru-ai 获取最新 dev 分支
```
...
Rimuru AI 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/gowdaman-dev/rimuru-ai/releases) 或 [rimurucode.vercel.app/download](https://rimurucode.vercel.app/download) 下载。
...
Rimuru AI 内置两种 Agent，可用 `Tab` 键快速切换：
...
了解更多 [Agents](https://rimurucode.vercel.app/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://rimurucode.vercel.app/docs)。
...
如果你在项目名中使用了 “rimuru-ai”（如 “rimuru-ai-dashboard” 或 “rimuru-ai-mobile”），请在 README 里注明该项目不是 Rimuru AI 团队官方开发，且不存在隶属关系。

---

**加入我们的社区** [飞书](https://applink.feishu.cn/client/chat/chatter/add_by_link?link_token=738j8655-cd59-4633-a30a-1124e0096789&qr_code=true) | [X.com](https://x.com/rimuru-ai)

...
# Paketmanager
npm i -g rimuru-ai@latest        # oder bun/pnpm/yarn
scoop install rimuru-ai             # Windows
choco install rimuru-ai             # Windows
brew install gowdaman/tap/rimuru-ai # macOS und Linux (empfohlen, immer aktuell)
brew install rimuru-ai              # macOS und Linux (offizielle Brew-Formula, seltener aktualisiert)
sudo pacman -S rimuru-ai            # Arch Linux (Stable)
paru -S rimuru-ai-bin               # Arch Linux (Latest from AUR)
mise use -g rimuru-ai               # jedes Betriebssystem
nix run nixpkgs#rimuru-ai           # oder github:gowdaman/rimuru-ai für den neuesten dev-Branch
```
...
Rimuru AI enthält zwei eingebaute Agents, zwischen denen du mit der `Tab`-Taste wechseln kannst.
...
Mehr dazu unter [Agents](https://rimurucode.vercel.app/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von Rimuru AI findest du in unseren [**Docs**](https://rimurucode.vercel.app/docs).

### Beitragen

Wenn du zu Rimuru AI beitragen möchtest, lies bitte unsere [Contributing Docs](./CONTRIBUTING.md), bevor du einen Pull Request einreichst.

### Auf Rimuru AI aufbauen

Wenn du an einem Projekt arbeitest, das mit Rimuru AI zusammenhängt und "rimuru-ai" als Teil seines Namens verwendet (z.B. "rimuru-ai-dashboard" oder "rimuru-ai-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom Rimuru AI-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.

---

**Tritt unserer Community bei** [Discord](https://discord.gg/rimuru-ai) | [X.com](https://x.com/rimuru-ai)

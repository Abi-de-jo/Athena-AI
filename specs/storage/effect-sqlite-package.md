...
- `@rimurucode-ai/effect-drizzle-sqlite`
...
1. Add `@rimurucode-ai/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@rimurucode-ai/effect-drizzle-sqlite` as a dependency of `packages/opencode`.

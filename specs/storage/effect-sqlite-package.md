...
- `@rimuru-ai/effect-drizzle-sqlite`
...
1. Add `@rimuru-ai/effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@rimuru-ai/effect-drizzle-sqlite` as a dependency of `packages/opencode`.

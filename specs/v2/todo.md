...
- remove the public in-memory `@rimurucode-ai/llm` tool loop after replacing its
...
- plugins get global "rimuru-ai" instance like in that post i showed
...
- decide whether to preserve deprecated `@rimurucode-ai/llm` orchestration exports

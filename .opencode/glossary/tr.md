...
- Keep lowercase `rimuru-ai` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenCode` in prose, `rimuru-ai` only for exact technical identifiers
...
- Avoid changing `rimuru-ai` to `OpenCode` inside commands, URLs, package names, or code literals
